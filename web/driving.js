(function(config) {
    ...
    function pa() {
        ...
        return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf("nvs") ? (b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push("Quadro"), 0 <= a.indexOf("nvs") && b.push("NVS"), a.match(/\bion\b/) && b.push("ION"), a.match(/gtx\b/) ? b.push("GTX") : a.match(/gts\b/) ? b.push("GTS") : a.match(/gt\b/) ? b.push("GT") : a.match(/gs\b/) ? b.push("GS") : a.match(/ge\b/) ? b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(oa)) && b.push(c[1].toUpperCase().replace("GS", "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) : 0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a.indexOf("firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <= c && b.push("Radeon"), 0 <= a.indexOf("firepro") ? b.push("FirePro") : 0 <= a.indexOf("firegl") && b.push("FireGL"), 0 <= a.indexOf("hd") && b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(oa)) && b.push(c[1].toUpperCase().replace("HD", "")), b = b.join(" ")) : a.substring(0, 100)
    }
    ...
    Ib = function() {
        ...
        for (var a = ["webgl", "experimental-webgl", "moz-webgl"], b = null, c = 0; c < a.length; c += 1) {
            ...
            if (b) {
                ...
                if (window.forceWebGL) return Fb = a[c],
                Gb = Infinity,
                !0;
    ...
    Kb = !Cb || cb || Ea || rb && lb || Ya || Oa || Ia || La || Ta || ia("gt-n710") || Ca,
    Lb = !Kb && !Jb,
    Mb = Jb ? "vw": Kb ? "d": Lb ? "dv": "v",
    Nb = ia("webkit"),
    Qb = "WebKitCSSMatrix" in da && "m11" in new window.WebKitCSSMatrix,
    ...
    g.c.xa = g.BuryPoint.addOptions = function(a, b) {
        if (!a.Rna) if (b && (b.innerLayer || b.innerOverlay)) a.O0 = !0;
        else {
            a.Rna = !0;
            var c = a.CLASS_NAME;
            if (c) {
    ...
    g.Z.extend = g.Z.extend = function(a) {
        ...
        a.D && e.D && (a.D = g.extend({},
        e.D, a.D));
        var h = e.constructor.Cla,
        k = {};
    ...
    g.My = {
        ...
        send: function() {
            ...
            a.length && (a = ["type=nfl", "k=" + g.w.key, "m=" + (g.l.Y ? 1 : 0), "pf=" + g.l.Nx, "v=" + g.w.Bq, "branch=JSAPI", "log=" + a.join("!")], a = g.w.vc + "://webapi.amap.com/count?" + a.join("&"), new g.fb.sb(a))
        }
    };
    ...
    g.ra = {
        ...
        I: function(a, b, c) {
            ...
            var d = this.Ue;
            if (d && d[a]) for (var e = 0; e < d[a].length; e += 1) if (! (d[a][e].rb !== b && "mv" !== b || c && d[a][e].Je !== c)) {
                d[a].splice(e, 1);
                d[a].length || (d[a] = null);
                break
            }
        ...
        q: function(a, b) {
            ...
            for (var d = [].concat(this.Ue[a]), e = 0; e < d.length; e += 1) d[e].rb && (d[e].rb.call(d[e].Je || this, c), d[e] && d[e].Ij && this.Ue[a] && this.Ue[a].splice(e, 1));
            return this
        },
        Wh: function(a) {
    ...
    g.Ge = {
        set: function(a, b, c) {
            ...
            if (d && d[a]) {
                ...
                e = "set" + this.b0(a);
                if (d[e]) {
                    var f = !1; ! 0 == d.B ? f = !0 : d.B = !0;
                    d[e](b, c);
                    f || (d.B = !1);
                    c || this.XH(a, b)
                } else d.set(a, b, c)
            } else(this.He = this.He || {})[a] = b,
            c || this.XH(a, b)
        },
        b0: function() {
            var a = {};
        ...
        get: function(a, b, c) {
            ...
            c[d] ? (a = !1, !0 == c.B ? a = !0 : c.B = !0, b = c[d](b), a || (c.B = !1), b) : c.get(a, b);
            if (!c && this[d]) return a = !1,
            !0 == this.B ? a = !0 : this.B = !0,
            b = this[d](b),
            a || (this.B = !1),
            b;
    ...
    g.w = {
        ...
        key: "c536f4eae991666b64267ca01f855153",
        vc: "http",
        ...
        g.Fh = {
            ...
            EO: function(b) {
                ...
                if (g.l.Y) {
                    ...
                    d.push("&mo=" + encodeURIComponent(g.w.du + "/?r=" + c.join(",") + "&callapp=0&sourceApplication=jsapi_r_" + b.t));
                    return d.join("")
                }
    ...
    g.a = {
        ...
        Ro: function(a) {
            ...
            if (0 == a.indexOf("#")) {
                ...
                this.rk(a.substr(6) + a.substr(0, 6))
            } else {
                if (0 == a.indexOf("rgb(")) return a = this.Spa(a),
                a.push(1),
                a;
        ...
        aja: "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",
        lf: Date.now ?
        function() {
            return Date.now()
        }: function() {
        ...
        ha: "function" === typeof Array.prototype.ha ?
        function(a, b) {
            return a.ha(b)
        }: function(a, b) {
        ...
        i2: function(a) {
            return "undefined" !== typeof JSON && JSON.stringify ? g.a.w4(JSON.stringify(a)) : null
        },
        Pza: function(a, b) {
        ...
        iepngFix: function(a) {
            ...
            100) : this.uP || g.pb.load("AMap.FixPng", b)
        },
        Ha: function(a) {
            if (g.a.isArray(a)) if (g.a.isArray(a[0])) for (var b = 0; b < a.length; b += 1) a[b] = g.a.Ha(a[b]);
    ...
    g.a.gZ = window.cancelIdleCallback ? window.cancelIdleCallback.bind(window) : function(a) {
        ...
        a.a.xO = function(d, e) {
            ...
            function(b) {
                l || (clearTimeout(k), k = void 0, 2 === b.code && 0 < b.message.indexOf("permission") ? a.pb.load("AMap.GeoRemoteLoc",
                function() {
                    d(null, a.o6, h)
                }) : d(null, f))
            },
        ...
        var b = a.Z.extend({
            ...
            j_: function(b) {
                ...
                b = b.map.pa;
                for (var d = 0,
                e = b.length; d < e; d++) if (a.o.Kh && b[d] instanceof a.o.Kh && b[d].ga && b[d].ga.length && ( - 1 !== b[d].ga.indexOf("building") || -1 !== b[d].ga.indexOf("poilabel")) && b[d].La) {
        ...
        function d(a) {
            ...
            function(d) {
                ...
                for (var h = d.length,
                n = 0,
                p = Date.now() - f.jy, t = [], f = 0; f < h; f++) b(d[f], e)
            },
            !1)
        }
        function e(d, h) {
        ...
        a.extend(e.prototype, {
            ...
            rea: function() {
                ...
                if (this.ew) {
                    for (var b = 0,
                    c = this.ew.length; b < c; b++) this.ew[b].apply(null, a);
                    this.ew.length = 0
                }
            },
            $s: function(a) {
            ...
            Jf: function(b, c) {
                var d = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : a.a.Br,
                f = this;
                b = b || f.bE;
                var h = {};
                if (a.a.Fj(c, "object")) {
                ...
                f.Yz(null, h);
                f.ZP(function(a) {
                    a ? d(a) : f.DM ? (a = f.RU(c, f.JK(f.hz, b), !0), f.DM.sendMessage(e.KO + ":injectCode", a,
                    function(a, b) {
                        a || f.Yz(f.DM, h);
                        d(a, b)
            ...
            Yz: function(a, b) {
                if (!b) this.kn || (this.kn = this.E8(this.pE)),
                b = this.kn;
                else if (this.kn) for (var c in b) b.hasOwnProperty(c) && (this.kn[c] = b[c]);
                for (c in b) if (b.hasOwnProperty(c)) {
                    var d = b[c];
                    "function" === typeof d && (this[c] = this.G$(c, d, a))
                }
                this.iea = !!a
            },
            RU: function(a, b) {
            ...
            gea: function(a) {
                ...
                c && c !== r ? c.ZP(function(b, c) {
                    b ? a.call(r, b) : c.Nsa.sendMessage(e.KO + ":injectCode", h,
                    function(b) {
            ...
            h8: function(b, c) {
                ...
                if (!b.nX) {
                    ...
                    b.nX = setTimeout(function() {
                        b.nX = null;
                        var c = b.AL;
                        c.length && (d.bw(b, 1 === c.length ? c[0] : {
                            jy: a.a.lf(),
                            Jpa: c
                        }), c.length = 0)
                    },
            ...
            Caa: function(a, b) {
                ...
                c.kfa(a);
                var d = this.r9(a);
                if (e.b9) b.call(c, null, {
                    sendMessage: d
                });
                else {
                    e.b9 = !0;
                    var f = [c.MU() + ":checkup", Math.random().toFixed(5) + "", Math.round(1E3 * Math.random()), !1,
                    function(a, e) {
                        var k = !0;
                        if (a || !e || e.length !== f.length - 2) k = !1;
                        else for (var h = 0,
                        v = e.length; h < v; h++) if (e[h] !== f[h + 1]) {
                            k = !1;
                            break
                        }
                        k ? b.call(c, null, {
        ...
        if (!g.ze) {
            ...
            b.end = function(b) {
                ...
                else return b.zc(Error("Duplicate Invoke"));
                b.zc(null)
            };
            b.push = function(b) {
            ...
            b.send = function(b) {
                ...
                b.push("jl=" + (d.FB ? 1 : 0));
                if (l.Fj(window.performance, "performance") && l.Fj(window.performance.getEntriesByType, "function")) {
                    var n = 0,
                    p = ["webapi.amap.com", "jsapi-test.amap.test", "localhost"],
                    q = ["/maps", "/css"];
                    l.Nb(window.performance.getEntriesByType("resource"),
                    function(a) {
                        var b = void 0,
                        c = void 0;
                ...
                var b = new g.Uy(function() {
                    return {
                        ...
                        bh: function(a, b) {
                            var e = a.zd,
                            f = a.pe,
                            h = "building" === a.ga[0]; (f && e !== this.Gv.mu && this.Gv.mu || !f && !h && e !== this.Gv.Gj && this.Gv.Gj) && this.Ofa( !! f);
                            f ? this.Gv.mu = e: h || (this.Gv.Gj = e);
                            this.pma(a, b)
                        },
                        Ofa: function(a) {
                            if (a) this.qT();
                            else if (!a && Object.keys(this.lk).length) for (var b in this.lk) this.lk.hasOwnProperty(b) && (a = this.lk[b], a.os || a.abort())
                        },
                        Cra: function() {
                        ...
                        LQ: function(a) {
                            for (var b = 0,
                            e = a.length; b < e; b++) delete this.rj[a[b]];
                            this.vs -= a.length
                        },
                        sN: function(a) {
                            var b = a.ga;
                        ...
                        pma: function(a, b) {
                            ...
                            b)) {
                                ...
                                q.onreadystatechange = function() {
                                    if (4 === q.readyState && 0 === q.status) q.os || (q.os = !0, f.al(l, b), q.onreadystatechange = null, k ? f.xX(q) : delete f.lk[q.pC]),
                                    q = null;
                                    else if (!q.os) if (3 === q.readyState) {
                                        var h = q.responseText.substring(n);
                                        q.Cp = e(h, q.Cp);
                                        n = q.responseText.length
                                    } else 4 === q.readyState && (h = q.responseText.substring(n), a.Ag && (h += "|"), e(h, q.Cp, !0), q.Cp = "", k ? f.xX(q) : delete f.lk[q.pC], q = null)
                                };
                                q.onerror = function() {};
                                q.open("GET", m, !0);
                                q.send();
                        ...
                        TB: function(a) {
                            function b(d, p, r) {
                                ...
                                18 < k && !n && (s += "/" + k);
                                if (d && "loaded" !== d.status && -1 !== m.indexOf(t)) if ("limg" === t) p = h[1],
                                d.kd = p,
                                "string" === typeof p.b && (p.b = x.mz(p.b)),
                                r = "",
                                (r = "object" === typeof p.u ? p.u.url: p.u) && (p.u = {
                                    ...
                                    p = {
                                        ...
                                        xw: a.ht,
                                        xB: "building" === t,
                                        ci: "poilabel" === t || "roadlabel" === t || "building" === t && q
                                    };
                        ...
                        saa: function(a) {
                            for (var b = 0,
                            e = this.qn.length; b < e; b++) if (this.qn[b] === a) return ! 0;
                            return ! 1
                        },
                        iA: function() {
        ...
        JO: function(a) {
            ...
            do {
                ...
                b -= d.scrollTop || 0;
                c -= d.scrollLeft || 0;
                g.g.Dia() || !g.l.D5 && !k || (c += d.scrollWidth - d.clientWidth, k && "hidden" !== g.g.yd(d, "overflow-y") && "hidden" !== g.g.yd(d, "overflow") && (c += 17));
                d = d.parentNode
            } while ( d );
            return new g.G(c, b)
        },
        ...
        b4: function(a, b, c) {
            a.Bi = b; ! c && g.l.BF ? (b = g.g.$_(b), c = a.style[g.g.Xf].split("rotate"), 1 < c.length ? (c[0] = b, a.style[g.g.Xf] = c.join("rotate")) : a.style[g.g.Xf] = b, g.l.U1 && (a.style.WebkitBackfaceVisibility = "hidden")) : (a.style.left = b.x + "px", a.style.top = b.y + "px")
        },
        ne: function(a) {
            a.Bi || (a.Bi = a.style.left ? new g.G(parseInt(a.style.left), parseInt(a.style.top)) : new g.G(0, 0));
            return a.Bi
        },
        Fza: function(a, b) {
        ...
        var a = g.g.zR(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]),
        b;
        g.extend(g.g, {
            NZ: function() {
    ...
    })();g.g.Xf = g.g.zR(["WebkitTransform", "OTransform", "MozTransform", "msTransform", "transform"]);g.g.Ur = {
        transform: "transform",
        WebkitTransform: "-webkit-transform",
        OTransform: "-o-transform",
        MozTransform: "-moz-transform",
        msTransform: "-ms-transform"
    };g.g.xD = g.g.zR(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);g.g.Jta = "webkitTransition" === g.g.xD || "OTransition" === g.g.xD ? g.g.xD + "End": "transitionend";g.F = {
        h: function(a, b, c, d) {
            function e(b) {
                b = b || window.event;
            ...
            var f = g.a.Ab(a) + "_" + g.a.Ab(c) + "_" + g.a.Ab(d || a),
            h = b + f;
            if (a[h]) return this;
            var k = b;
            ...
            if (g.l.T2 && 0 === b.indexOf("touch")) return a[h] = e,
            this.Wfa(a, b, e, f);
        ...
        I: function(a, b, c, d) {
            ...
            d = b + c;
            var e = a[d];
            g.l.WN && "mousewheel" === b && (b = "DOMMouseScroll"); ! g.l.mr || "mouseover" !== b && "mouseout" !== b || (b = "mouseover" === b ? "mouseenter": "mouseleave");
            g.l.T2 && -1 < b.indexOf("touch") ? this.mpa(a, b, c) : g.l.sf && "dblclick" === b && this.ipa ? this.ipa(a, c) : "removeEventListener" in a ? a.removeEventListener(b, e, !1) : "detachEvent" in a && -1 === b.indexOf("touch") ? e && a.detachEvent("on" + b, e) : a["on" + b] = null;
            a[d] = void 0;
            return this
        },
        Mza: function(a, b) {
        ...
        Uqa: function(a) {
            ...
            g.l.sf && (g.F.h(a, "touchstart", b, this), g.F.h(a, "touchmove", b, this), g.F.h(a, "touchend", b, this));
        ...
        mja: function(a, b) {
            var c = b.EJ || b.getBoundingClientRect(),
            d = b.dT || [b.clientLeft, b.clientTop];
        ...
        wl: function(a, b) {
            ...
            c = new g.G(g.l.sf ? a.pageX: a.clientX + (c.scrollLeft || d.scrollLeft), g.l.sf ? a.pageY: a.clientY + (c.scrollTop || d.scrollTop));
        ...
        Xfa: function(a, b, c, d) {
            ...
            a.addEventListener(this.Gn("pointercancel"), e, !1);
            return this
        },
        mpa: function(a, b, c) {
            c = a["_amap_" + b + c];
            ...
            case "touchmove":
                ...
                break;
            case "touchend":
                a.removeEventListener(this.Gn("pointerup"), c, !1),
                a.removeEventListener(this.Gn("pointercancel"), c, !1)
            }
            return this
        }
    }); (function() {
        ...
        g.extend(g.F, {
            ...
            aza: function(b, d) {
                ...
                b.uo.length || (c ? b.detachEvent("onresize", a) : (b.vo.contentDocument.defaultView.removeEventListener("resize", a), b.vo = !b.removeChild(b.vo)))
            },
            rha: function(a) {
                a.uo = null;
                if (a.vo) {
        ...
        Rm: function(a, b) {
            ...
            c.status = 1;
            for (var e = 0,
            f = c.Aw.length; e < f; e += 1) c.Aw[e]();
            c.Aw = []
        },
        vd: function(a, b) {
            var c = this;
            c.timeout = setTimeout(function() {
                1 !== c.pt[a].status ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
            },
            5E3)
        },
        NA: function(a) {
            this.pt[a] || (this.pt[a] = {},
            this.pt[a].status = 0, this.pt[a].Aw = []);
            return this.pt[a]
        },
        remove: function(a) {
            this.pt[a] = null
        ...
        try { ! c && window.localStorage && b && "" !== b && g.l.tr && window.localStorage.setItem("_AMap_" + a, JSON.stringify({
                css: b,
                version: g.w.hj
            }))
        } catch(d) {}
        var e = document.createElement("style");
        e.type = "text/css"; - 1 === g.w.vb.indexOf("webapi.amap.com") && (b = b.replace(/webapi.amap.com/gi, g.w.vb.split("://")[1]));
        ...
        if (!g.indexedDB && b.ni) {
            ...
            if (c) {
                ...
                g.indexedDB = {
                    sA: function(a, b) {
                        f ? "function" === typeof a && a() : h.h("dbReady",
                        function(c) {
                    ...
                    yea: b(function(a, b) {
                        ...
                        c.openCursor(d.bound(a[0], a[a.length - 1])).onsuccess = function(c) {
                            if (c = c.target.result) {
                                ...
                                for (var d = -1,
                                f = 0,
                                k = a.length; f < k; f++) if (a[f] > c.value.tileKey) {
                                    d = f;
                                    break
                                }
                                c["continue"](a[d])
        ...
        function b(a) {
            var b = g.w.hj + "|" + a.oi.replace(/\//g, ",") + "|" + (a.mf ? "w": "v") + "|",
            c;
            c = a.ia;
            var d = a.ge;
        ...
        function e() {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : r.Br;
            k();
        ...
        function n(a) {
            if ("object" === typeof a && null !== a) {
                ...
                } else if (r.Fj(a, "Float32Array")) b.push("__Float32Array"),
                b.push(Array.prototype.slice.call(a));
                else if (r.Fj(a, "Uint16Array")) b.push("__Uint16Array"),
                b.push(Array.prototype.slice.call(a));
                else for (d in b = {},
        ...
        function p(a) {
            if ("object" === typeof a && null !== a) {
                var b = {};
                if (r.isArray(a)) if ("__Float32Array" === a[0]) b = new Float32Array(a[1]);
        ...
        if (!g.mj && q.ni) {
            ...
            x = {
                ...
                setItem: function(a, b, c) {
                    var d = b;
                    c && (d = JSON.stringify(b), 1.5 < d.length / 1024 / 1024 && Object.keys(b.Bm).length && (b.Bm = {},
                    d = JSON.stringify(b)));
                    try {
            ...
            g.mj = {
                ...
                get: function(c, d) {
                    ...
                    var h = "FS" === c.type;
                    if (!q.tr || !(h || q.ni && 0 !== u.data.keys.length)) return d({
                        code: 1
                    });
                    var l = [],
                    x = [],
                    ...
                    function(b, c) {
                        if (b || c.length !== A.length) b && 3 === b.code ? q.ni = !1 : e(),
                        H = x,
                        x = [],
                        f(null);
                        else {
                ...
                set: function(a, c) {
                    a.vf && a.vf !== u.data.VI && (l(a.vf), e(), c && c({
                        code: 2
        ...
        r: function(a, b, c) {
            var d = parseFloat(b),
            e = parseFloat(a);
            if (isNaN(a) || isNaN(b)) throw "Invalid Object: LngLat(" + e + ", " + d + ")"; ! 0 !== c && (d = Math.max(Math.min(d, 90), -90), e = (e + 180) % 360 + ( - 180 > e || 180 === e ? 180 : -180));
            this.P = d;
            this.R = e
        },
        tO: function() {
        ...
        var s = b.P * f;
        b = b.R * f;
        for (var k = 2 * k(l(n(m((r - s) / 2), 2) + p(r) * p(s) * n(m((a - b) / 2), 2))), u, v, x, t, f = 1; f < c; f += 1) u = 1 / c * f,
        v = m((1 - u) * k) / m(k),
        x = m(u * k) / m(k),
        ...
        v = q(v, l(n(u, 2) + n(t, 2))),
        u = q(t, u),
        b > a ? (u < a && (u += 2 * e), u > b && (u -= 2 * e)) : (u > a && (u -= 2 * e), u < b && (u += 2 * e)),
        ...
        r: function() {
            ...
            else if (2 === arguments.length) a = g.a.Ha(arguments[0]),
        ...
        ib: function() {
            return new g.we(this.qc.ib(), this.cc.ib())
        },
        cb: function(a) {
        ...
        cb: function(a) {
            return a instanceof g.md && this.width === a.width && this.height === a.height
        },
        toString: function() {
        ...
        lO: function(a) {
            for (var b = [], c = 0; c < this.path.length; c += 1) b[c] = a.$b(this.path[c], 20);
            return b
        },
        iO: function(a) {
        ...
        r: function() {
            if (2 === arguments.length) this.Zb = arguments[0],
            this.Md = arguments[1];
        ...
        contains: function(a) {
            var b;
            a instanceof g.yf ? (b = a.Zb, a = a.Md) : b = a;
    ...
    g.Eh.fD, {
        code: "EPSG:4326",
        nf: g.so.JS,
        IC: new g.yD(1 / 360, 0.5, -1 / 360, 0.25)
    });g.Eh.Fta = g.extend({},
    g.Eh.fD, {
        nf: g.so.JS,
        IC: new g.yD(1, 0, 1, 0)
        ...
        Ewa: function(a) {
            return a ? this.$b(this.get("center"), a) : this.get("centerPixel")
        },
        mua: function(a) {
        ...
        D: {
            ...
            copyright: "\x3c!--v1.4.11--\x3e &copy " + (new Date).getFullYear() + " AutoNavi ",
            isHotspot: !g.l.Y,
            baseRender: g.l.LY,
        ...
        setCity: function(a, b) {
            ...
            var c = this; (new g.fb.sb(g.w.Od + "/v3/config/district?subdistrict=0&extensions=all&key=" + g.w.key + "&s=rsv3&output=json&keywords=" + a, {
                callback: "callback"
            })).h("complete",
            function(d) {
                var e = d.districts;
        ...
        getCity: function(a, b) {
            ...
            var c = g.w.Od + "/v3/geocode/regeo?&extensions=&&key=" + g.w.key + "&s=rsv3&output=json&location=" + (b || this.get("center", null, !0)); (new g.fb.sb(c, {
                callback: "callback",
                ww: !0,
                dd: "REGEO"
            })).h("complete",
        ...
        r: function(a, b) {
            ...
            var f = []; (b.gridMapForeign || b.vectorMapForeign) && f.push("gridmap");
            b.vectorMapForeign && g.l.lt && f.push("MVT", "vectorForeign");
        ...
        Nja: function(a, b, c) {
            ...
            if ((a = new g.we(a[0], a[1], a[2], a[3])) && b && d) {
        ...
        Eqa: function(a, b) {
            ...
            e && (this.uv = new g.ij(d, a, null, 0), this.uv.transition = function(a, c, e) {
                e /= b || 300;
                if (1 <= e) return c;
                var f = {},
                h;
        ...
        Sfa: function() {
            var a = this; ! a.Bl && a.J && (a.indoorMap = a.Bl = new AMap.IndoorMap({
                innerLayer: !0
            }), a.nR(), g.a.Kc(function() {
                a.q("indoor_create", {
                    target: a
                });
                a.set("display")
        ...
        layersChanged: function() {
            ...
            this.zH = this.B = !1;
            for (var b = 0; b < a.length; b += 1) a[b].B = !0,
        ...
        t5: function() {
            function a() {
                ...
                g.a.Nb(b.D.layers,
                function(b) {
                    if (b.sE && b.constructor === C.o.lb) return a = !0,
                    !1
                },
                b);
                if (g.a.ha(["d", "dv"], b.get("baseRender")) || !g.a.ha(["normal", "amap://styles/normal"], b.get("mapStyle")) || "3D" === b.get("viewMode") && 0 < b.get("pitch") || "all" !== b.get("features") || b.get("editEnable") || !b.get("turboMode")) a = !1;
                return a
            }
            if (!this.h3) {
                var b = this,
                ...
                this.set("rasterLayer", void 0);
                    ...
                    if (this.D.layers) {
                        var e = null;
                        g.a.Nb(this.D.layers,
                        function(a) {
                            a instanceof C.o.lb && a.sE && (null === e || a.get("zIndex") > e.get("zIndex")) && (e = a)
                        });
        ...
        Yga: function(a) {
            ...
            a.layers && 0 !== a.layers.length ? this.set("defaultLayer", a.layers[0], !0) : (b = new C.o.lb({
                innerLayer: !0
            }), a.layers = [b], b.IM = !0, this.set("defaultLayer", b, !0));
            if (b = a.view) b.D.rotation && (a.rotation = b.D.rotation),
            b.D.center && (a.center = b.D.center),
            b.D.zoom && (a.zoom = Math.max(a.zooms[0], Math.min(a.zooms[1], b.D.zoom))),
            b.D.crs && (a.crs = b.D.crs);
        ...
        setCenter: function(a, b) {
            ...
            a = g.a.Ha(a);
            b || !this.loaded ? (this.q("movestart"), this.set("center", a), this.q("mapmove"), this.map ? this.map.q("moveend") : this.q("moveend")) : (this.B = !0, this.panTo(a), this.B = !1)
        },
        ...
        setRotation: function() {
            ...
            g.c.add(this, "setRotation"); ! g.l.cf && this.get("rotateEnable") && this.set("rotation", a)
        },
        ...
        dB: function(a) {
            return this.view && "3D" === this.view.type ? g.a.Yc(a, 4) : Math.round(a)
        },
        ...
        clearMap: function() {
            ...
            this.set("overlays", []);
            if (this.map && this.map.pa) for (a = this.map.pa, b = a.length - 1; 0 <= b; b -= 1) if (a[b].X instanceof C.o.gJ) {
                var c = a[b].X;
                c.B = !0;
                c.setMap(null);
                c.B = !1
        ...
        getAllOverlays: function(a, b) {
            ...
            if (a) {
                for (var d = "amap." + a.toLowerCase(), e = [], f = 0; f < c.length; f += 1) d !== c[f].CLASS_NAME.toLowerCase() || !b && (c[f].wa || c[f].isOfficial) || e.push(c[f]);
                return e
            }
            if (!b) {
                e = [];
            ...
            e = [];
            if (d) for (var f = 0,
            h = d.length; f < h; f += 1) d[f] instanceof C.o.gJ && e.push(d[f]);
            return c.concat(e)
        },
        ...
        getSize: function() {
            g.c.add(this, "getSize"); (!this.UD || 10 > this.UD.width * this.UD.height) && this.refreshSize();
            return this.UD
        },
        ...
        panBy: function(a, b, c) {
            ...
            e = this.Ee(e); ! this.loaded || c ? this.setCenter(e, c) : this.set("panTo", e);
            this.B = !1
        },
        setFitView: function(a, b, c, d) {
            ...
            if (a = this.M_(a)) {
                if (c = this.DG(a, 0, new g.G(40, 40), c, d)) b = b || !this.getBounds().contains(a.Yh()) || g.l.Y && 1 < Math.abs(c[0] + this.get("zoom", null, !0)),
        ...
        M_: function(a) {
            if (a) if (a instanceof C.A.Jh) a = [a];
            else {
        ...
        DG: function(a, b, c, d, e) {
            ...
            do {
                ...
                r = -Infinity,
                s = -Infinity,
                u = 0; u < a.length; u += 1) var v = this.wA.te(a[u]), p = Math.min(p, v.x), r = Math.max(r, v.x), q = Math.min(q, v.y), s = Math.max(s, v.y);
                p = r - p;
                q = s - q;
            ...
            if (this.B) {
                for (var b = [], c = -1, d = a.length; ++c < d;) {
                    ...
                    if (e.AV) for (var e = e.pka(), f = -1, h = e.length; ++f < h;) {
                        var k = e[f]; - 1 === g.a.indexOf(a, k) && b.push(k)
                    }
                }
                a = a.concat(b)
        ...
        removeListener: function(a) {
            a instanceof g.hD && (g.a.bi(a.ai.removeListener) ? a.ai.removeListener(a) : 0 === a.type ? g.F.I(a.ai, a.PN, a.TO, a.Je) : 1 === a.type && (a.ai.be || (a.ai.be = g.ra.be), g.ra.I.call(a.ai, a.PN, a.TO, a.Je)))
        },
        N: function(a, b) {
    ...
    pc;
    for (pc in oc) oc.hasOwnProperty(pc) && (C.event[oc[pc]] = C.event[pc]);g.event = C.event;C.o.Ec = g.Z.extend({
        ha: [g.ra, g.Ge],
        ...
        setMap: function(a) {
            g.c.add(this, "setMap");
            var b = this.get("map");
            if (a) b && a !== b && b.Nj(this),
            this.set("map", a);
            else if (b && (b.Nj(this), this.set("map", null, !0), this.Uh = !1, this.Gg && this.Gg(), this.onRemove)) this.onRemove()
        },
        getMap: function() {
            g.c.add(this, "getMap");
        ...
        r: function(a) {
            ...
            g.c.xa(this, a); (a = a || {}) && a.tileUrl && (a.getTileUrl = a.tileUrl);
            this.dha(a);
            var b = a.zooms;
        ...
        sg: function(a) {
            ...
            if (b) if (this.vp = !0, g.o.Kh) {
                if ("dv" === c.get("baseRender") && !this.get("watermark")) {
                    ...
                    d = new g.o.lb(this, a, this.kq(this.S_(!b)), void 0, !0);
                    b && (d.Lk = new g.o.gd(new C.o.lb({
                        zooms: [16, 20],
                        innerLayer: !0
                    }), a, ["building"]), d.Lk.type = "\u697c\u5757\u56fe\u5c42", d.Lk.Ie(["visible", "opacity", "zIndex"], d, !0), d.Lk.BA(c.get("mapStyle") || "normal"));
                    d.type = "\u6805\u683c\u5e95\u56fe";
                    return d
                }
                if ("v" <= c.get("baseRender") || this.get("watermark")) return "3D" == a.C.view.type ? (c = new g.o.gd(this, a, ["region", "road"]), c.type = "\u77e2\u91cf\u5e95\u56fe", b = new C.o.lb({
                    ...
                    zIndex: 50,
                    innerLayer: !0
                }), c.Lk = new g.o.gd(b, a, ["building"]), c.Lk.Oe = 17, c.Lk.type = "\u697c\u5757\u56fe\u5c42", c.Lk.jx = 1, c.Lk.Ie(["visible", "merge", "sort", "opacity"], c, !0), b.W("rejectMapMask", this, !0)) : (c = new g.o.gd(this, a, ["region", "building", "road"]), c.type = "\u77e2\u91cf\u5e95\u56fe"),
                a.tga = c
            } else return ["vectorlayer", "overlay"];
            else return this.vp = !1,
            new g.o.lb(this, a, null, this.D.maxDataZoom)
        },
        ...
        dha: function(a) {
            ...
            g.l.Y && g.l.ia && this.D.detectRetina && !b && (this.Gk[1] -= 1)
        },
        getTiles: function() {
        ...
        setTileUrl: function(a) {
            ...
            this.mZ() ? (this.set("getTileUrl", a), this.Jr()) : this.set("getTileUrl", a)
        },
        kq: function(a) {
            var b = this,
            c, d, e;
                ...
                function(l) {
                    if (l) h();
                        ...
                        m.src = function(a, c, d) {
                            ...
                            return g.w.vc + "://grid.amap.com/grid/" + d + "/" + a + "/" + c + "?src=jsapi&key=" + g.w.key + "&lang=" + e + "&dpiType=" + (g.l.bd ? "wprd": "webrd")
                        } (a, d, e)
                    }
                })
            })
        ...
        sg: function(a) {
            if (g.l.lt) return a = new g.o.r7(this, a),
            a.jx = this.get("heightFactor") || 1,
            a
        },
        setStyle: function(a) {
        ...
        getElement: function() {
            return this.o.O ? this.o.O.Wb: this.o.Rf ? this.o.Rf.Wb: null
        }
        ...
        setStyle: function(a) {
            ...
            if (a instanceof Array) {
                ...
                a[b].size = g.a.Ap(a[b].size),
                a.ef = Math.max(a.ef || 0, a[b].size.width + a[b].anchor.x),
                a.Pf = Math.max(a.ef || 0, a[b].size.height + a[b].anchor.y);
                this.Il = a
            } else a.size && (a.size = g.a.Ap(a.size)),
            ...
            this.Il.ef = this.Il.size.width + this.Il.anchor.x,
            this.Il.Pf = this.Il.size.height + this.Il.anchor.y;
            this.q("style")
        },
        setData: function(a) {
        ...
        sg: function(a) {
            return g.pb.AB(["cvector"]) ? (a = new g.o.Tc(this, a), this.W("datas", a), a) : ["cvector"]
        }
        ...
        show: function() {
            for (var a = -1,
            b = this.$l.length; ++a < b;) this.$l[a].show()
        },
        hide: function() {
            for (var a = -1,
            b = this.$l.length; ++a < b;) this.$l[a].hide()
        },
        setzIndex: function(a, b) {
            g.c.add(this, "setzIndex");
            this.set("zIndex", a);
            var c = this.$l;
            if ("undefined" === typeof b) for (var d = -1,
            e = c.length; ++d < e;) {
                var f = c[d];
                f.setzIndex(a)
        ...
        close: function() {
            ...
            this.B = !0;
            this.setMap(null);
            this.map && (this.map = this.map.Dw = null, this.q("close", {
                type: "close",
                target: this
            }));
            this.B = !1
        ...
        open: function(a, b, c) {
            g.c.add(this, "open");
            b = g.a.Ha(b);
            if (a && !this.FI && (b = b || this.get("position", null, !0))) {
                this.q("change", {
                    type: "change",
                    target: this
                });
        ...
        getSerializedPath: function() {
            ...
            for (var a = this.get("path", null, !0), b = [], c = 0, d = a.length; c < d; c++) {
                ...
                if (e instanceof g.T) {
                    ...
                    k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[h].tO()),
                    f.push(e.controlPoints[h].pO());
                    f.push(e.tO());
                    f.push(e.pO());
                    b.push(f)
                } else b.push(e)
        ...
        Jda: function(a) {
            ...
            if (a instanceof g.T) b = a;
                ...
                } else if (g.a.isArray(a[0])) for (d = a.length, b = new g.T(a[d - 1][0], a[d - 1][1]), c = 0, d -= 1; c < d; c++) e.push(new g.T(a[c][0], a[c][1]));
        ...
        AO: function(a) {
            ...
            h = a[e + 1],
            k = f.R * b * Math.cos(f.P * Math.PI / 180),
            f = f.P * b,
            l = h.R * b * Math.cos(h.P * Math.PI / 180),
            c = c + (k * h.P * b - l * f);
            e = a[e];
            a = a[0];
        ...
        getArea: function() {
            ...
            var a = this.get("path", null, !0),
            b;
            if (!a.length || a[0] instanceof g.T) b = this.AO(a);
            else {
                b = this.AO(a[0]);
        ...
        contains: function(a) {
            ...
            a = [a.R, a.P];
            for (var c, d = 0,
            e = b.length; d < e && (c = this.Uga(b[d]), g.sd.mp(c) || c.reverse(), c = g.sd.Jd(a, c, 0 === d ? !0 : !1), 0 < d && (c = !c), c); d += 1);
            return c
        },
        Uga: function(a) {
        ...
        setCenter: function(a, b) {
            g.c.add(this, "setCenter"); (a = g.a.Ha(a)) && a instanceof g.T && (this.set("center", a), this.q("change", {
                type: "change",
                target: this
        ...
        contains: function(a) {
            ...
            b.B = !0;
            var d = !1;
            c.le(a) <= this.get("radius") * b.getResolution(c) && (d = !0);
            b.B = !1;
            return d
        }
    });
    ...
    g.xS = uc;uc.prototype = {
        ...
        b.prototype.toFixed = function(b) {
            ...
            e = 0; 16 > e; ++e) 0 !== d[e] && (d[e] = a.a.Yc(d[e], b));
            return this
        };
        ...
        Fq: function() {
            ...
            if (c && d) for (var c = g.a.Ha(c), e = a.radius || this.get("radius"), f = d.Vb(c), a = f.x, f = f.y, h = g.a.map(e,
            function(a) {
        ...
        mapChanged: function() {
            ...
            this.B = !1; ! this.Bg && this.get("map") && (this.Bg = !0, this.get("map").q("overlays"))
        },
        setCenter: function(a, b) {
            g.c.add(this, "setCenter"); (a = g.a.Ha(a)) && a instanceof g.T && (this.set("center", a), this.set("path", this.Fq()), this.Bg || (this.Bg = !0, this.get("map") && this.get("map").q("overlays")), b || (this.q("setCenter"), this.q("change", {
                type: "change",
                target: this
            })))
        },
        ...
        Fq: function() {
            ...
            if (b) {
                ...
                d = b.getNorthEast();
                b.B = !1;
                g.a.Nb([new g.T(c.R, c.P, !0), new g.T(d.R, c.P, !0), new g.T(d.R, d.P, !0), new g.T(c.R, d.P, !0)],
                function(b) {
                    return a.push(b)
                })
            }
        ...
        mapChanged: function() {
            g.a.bi(C.A.ns.Mc.mapChanged) && C.A.ns.Mc.mapChanged.apply(this);
            this.B = !0;
            this.setPath(this.Fq());
            this.B = !1; ! this.Bg && this.get("map") && (this.Bg = !0, this.get("map").q("overlays"))
        },
        ...
        setBounds: function(a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            g.c.add(this, "setBounds");
            a && a instanceof g.we && (this.set("bounds", a), this.set("path", this.Fq()), this.Bg || (this.Bg = !0, this.get("map") && this.get("map").q("overlays")), b || (this.q("change", {
                type: "change",
                target: this
            }), this.q("setBounds")))
        },
        ...
        add: function(a) {
            var b = this,
            c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : g.a.Br,
            d = this.xv || (this.xv = []);
            g.a.isArray(a) ? g.a.Nb(a,
            function(a) {
                b.add(a, c)
        ...
        remove: function(a) {
            ...
            c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : g.a.Br,
            d = this.xv;
            if (d) if (g.a.isArray(a)) g.a.Nb(a,
            function(a) {
                b.remove(a, c)
            });
            else {
        ...
        a.A.yS = a.A.Xm.extend({
            ...
            toGeoJSON: function() {
                ...
                for (var a = this.AG(), c = [], d = 0, e = a.length; d < e; d++) a[d].B = !0,
                c[d] = a[d].toGeoJSON(),
                a[d].B = !1;
                return c
            },
            ...
            LT: function(a) {
                ...
                b = this.D.coordsToLatLng(b ? b.coordinates: null),
                b = this.D.getMarker(a, b);
                this.zq(a, b);
                return b
            },
            H8: function(c) {
                for (var d = "Feature" === c.type ? c.geometry: c, d = d ? d.coordinates: null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.LT(b.extend({},
                c, {
                    type: "Feature",
                    properties: {
                        _isAmap: !0,
            ...
            G8: function(c) {
                for (var d = "Feature" === c.type ? c.geometry: c, d = d ? d.coordinates: null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.KT(b.extend({},
                c, {
                    type: "Feature",
                    properties: {
                        _isAmap: !0,
            ...
            I8: function(c) {
                for (var d = "Feature" === c.type ? c.geometry: c, d = d ? d.coordinates: null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.MT(b.extend({},
                c, {
                    type: "Feature",
                    properties: {
                        _isAmap: !0,
            ...
            A8: function(c) {
                for (var d = ("Feature" === c.type ? c.geometry: c).geometries, e = [], l = 0, m = d.length; l < m; l++) e.push(this.UK(b.extend({},
                c, {
                    type: "Feature",
                    properties: {
                        _isAmap: !0,
            ...
            zq: function(a, c) {
                c && a.properties && c.setExtData && (c.B = !0, c.setExtData(b.extend({},
                c.getExtData() || {},
                {
        ...
        Xq: function(a, b) {
            ...
            d = 0,
            e = 1,
            f = b.length; e < f; d = e, e += 1) c = Math.min(c, g.sd.Oqa(a, [b[d], b[e]]));
            return Math.sqrt(c)
        },
        Oqa: function(a, b) {
        ...
        function b(b, c) {
            ...
            return {
                ...
                ringArea: function(b) {
                    ...
                    var c = a.Tl.KN * a.Tl.st,
                    d = 0,
                    e = b.length;
                    if (3 > e) return 0;
                    for (var f = 0; f < e - 1; f += 1) var k = b[f],
                    h = b[f + 1],
                    u = k.R * c * Math.cos(k.P * a.Tl.st),
                    k = k.P * c,
                    v = h.R * c * Math.cos(h.P * a.Tl.st),
                    d = d + (u * h.P * c - v * k);
                    f = b[f];
                    b = b[0];
        ...
        a.extend(e.prototype, {
            ...
            distanceToLine: function(a, b) {
                ...
                for (var c = Infinity,
                d = 0,
                e = b.length; d < e - 1; d++) var n = this.closestOnSegment(a, b[d], b[d + 1]),
            ...
            isPointOnLine: function(a, b, c) {
                b = this.normalizeLine(b);
                for (var d = 0,
                e = b.length; d < e - 1; d++) if (this.isPointOnSegment(a, b[d], b[d + 1], c)) return ! 0;
                return ! 1
            },
            isPointOnRing: function(a, b, c) {
                b = this.normalizeLine(b);
                for (var d = 0,
                e = b.length; d < e; d++) if (this.isPointOnSegment(a, b[d], b[d === e - 1 ? 0 : d + 1], c)) return ! 0;
                return ! 1
            },
            isPointOnPolygon: function(a, b, c) {
                b = this.normalizeMultiLines(b);
                for (var d = 0,
                e = b.length; d < e; d++) if (this.isPointOnRing(a, b[d], c)) return ! 0;
                return ! 1
            },
            ...
            isRingInRing: function(a, b) {
                for (var c = 0,
                d = a.length; c < d; c++) if (!this.isPointInRing(a[c], b)) return ! 1;
                return ! 0
            },
            isPointInPolygon: function(a, b) {
                b = this.normalizeMultiLines(b);
                for (var c, d = 0,
                e = b.length; d < e && (c = this.isPointInRing(a, b[d]), 0 < d && (c = !c), c); d += 1);
                return c
            },
            ...
            doesSegmentLineIntersect: function(a, b, c) {
                c = this.normalizeLine(c);
                for (var d = 0,
                e = c.length; d < e - 1; d++) if (this.doesSegmentsIntersect(a, b, c[d], c[d + 1])) return ! 0;
                return ! 1
            },
            doesSegmentRingIntersect: function(a, b, c) {
                c = this.normalizeLine(c);
                for (var d = 0,
                e = c.length; d < e; d++) if (this.doesSegmentsIntersect(a, b, c[d], c[d === e - 1 ? 0 : d + 1])) return ! 0;
                return ! 1
            },
            doesSegmentPolygonIntersect: function(a, b, c) {
                c = this.normalizeMultiLines(c);
                for (var d = 0,
                e = c.length; d < e; d++) if (this.doesSegmentRingIntersect(a, b, c[d])) return ! 0;
                return ! 1
            },
            doesLineLineIntersect: function(a, b) {
                a = this.normalizeLine(a);
                for (var c = 0,
                d = a.length; c < d - 1; c++) if (this.doesSegmentLineIntersect(a[c], a[c + 1], b)) return ! 0;
                return ! 1
            },
            doesLineRingIntersect: function(a, b) {
                a = this.normalizeLine(a);
                for (var c = 0,
                d = a.length; c < d - 1; c++) if (this.doesSegmentRingIntersect(a[c], a[c + 1], b)) return ! 0;
                return ! 1
            },
            ...
            doesRingRingIntersect: function(a, b) {
                a = this.normalizeLine(a);
                for (var c = 0,
                d = a.length; c < d; c++) if (this.doesSegmentRingIntersect(a[c], a[c === d - 1 ? 0 : c + 1], b)) return ! 0;
                return ! 1
            },
            GM: function(a, b) {
                for (var c = 0,
                d = 0; d < a.length - 1; d += 1) {
            ...
            ZT: function(a, b) {
                ...
                u = b.length; s < u; s++) {
                    ...
                    p = v[v.length - 1];
                    for (var x = 0,
                    t = v.length; x < t; x++) q = v[x],
                    d(q) ? (d(p) || r.push(c()), r.push(q)) : d(p) && r.push(c()),
                    p = q;
                    e = n
                }
                return r
            ...
            distanceOfLine: function(a) {
                ...
                for (var b = 0,
                c = 0,
                d = a.length; c < d - 1; c++) b += this.distance(a[c], a[c + 1]);
                return b
            },
        ...
        var a = {}; (function() {
            function b(a) {
                for (var b = 0,
                e = a.length,
                f = 0; f < e - 1; f++) var h = a[f],
                k = a[f + 1],
                b = b + (k[0] - h[0]) * (k[1] + h[1]);
                if (a[e - 1][0] !== a[0][0] || a[e - 1][1] !== a[0][1]) h = a[e - 1],
                k = a[0],
                b += (k[0] - h[0]) * (k[1] + h[1]);
                return 0 >= b
            }
            ...
            a.Tj = function(a, e) {
                ...
                var l = a.length;
                e.forEach(b);
                for (var m = 0; m < e.length; m++) k.push(l),
                l += e[m].length,
                c(h, e[m]);
                h = this.JI(h, k);
        ...
        a.fJ = function() {
            function a(b, c, d, e, f) {
                for (var k, h = 0,
                l = c,
                n = d - e; l < d; l += e) h += (b[n] - b[l]) * (b[l + 1] + b[n + 1]),
                n = l;
                if (f === 0 < h) for (f = c; f < d; f += e) k = r(f, b[f], b[f + 1], k);
                else for (f = d - e; f >= c; f -= e) k = r(f, b[f], b[f + 1], k);
            ...
            function c(a, b) {
                ...
                d;
                do
                if (d = !1, c.t4 || !m(c, c.next) && 0 !== l(c.Fa, c, c.next)) c = c.next;
                else {
                    s(c);
                    c = b = c.Fa;
                    if (c === c.next) break;
            ...
            function d(a, b, e, f, r, u, D) {
                if (a) {
                    if (!D && u) {
                        var F = a,
                        B = F;
                        do null === B.z && (B.z = h(B.x, B.y, f, r, u)),
                        B.co = B.Fa,
                        B = B.Fk = B.next;
                        while (B !== F);
                        B.co.Fk = null;
                        ...
                        do {
                            ...
                            for (I = 0; B;) {
                                ...
                                for (N = M; 0 < K || 0 < N && H;) 0 !== K && (0 === N || !H || B.z <= H.z) ? (A = B, B = B.Fk, K--) : (A = H, H = H.Fk, N--),
                                G ? G.Fk = A: F = A,
                                A.co = G,
                                G = A;
                                B = H
                    ...
                    for (F = a; a.Fa !== a.next;) {
                        B = a.Fa;
                        H = a.next;
                        if (u) a: if (G = a.Fa, I = a.next, 0 <= l(G, a, I)) G = !1;
                        else {
                            K = h(G.x < a.x ? G.x < I.x ? G.x: I.x: a.x < I.x ? a.x: I.x, G.y < a.y ? G.y < I.y ? G.y: I.y: a.y < I.y ? a.y: I.y, f, r, u);
                            M = h(G.x > a.x ? G.x > I.x ? G.x: I.x: a.x > I.x ? a.x: I.x, G.y > a.y ? G.y > I.y ? G.y: I.y: a.y > I.y ? a.y: I.y, f, r, u);
                            for (A = a.Fk; A && A.z <= M;) {
                            ...
                            G = !0
                        } else a: if (G = a.Fa, I = a.next, 0 <= l(G, a, I)) G = !1;
                        else {
                        ...
                        F = a = H.next;
                            ...
                            if (D) if (1 === D) {
                                ...
                                do H = B.Fa,
                                G = B.next.next,
                                !m(H, G) && n(H, B, B.next, G) && p(H, G) && p(G, H) && (D.push(H.ce / F), D.push(B.ce / F), D.push(G.ce / F), s(B), s(B.next), B = a = G),
                                B = B.next;
                                while (B !== a);
                                a = B;
                                d(a, b, e, f, r, u, 2)
                                        ...
                                        for (F = D.next.next; F !== D.Fa;) {
                                            if (B = D.ce !== F.ce) if (B = void 0, B = D.next.ce !== F.ce) if (B = void 0, B = D.Fa.ce !== F.ce) {
                                                ...
                                                b: {
                                                    B = D;
                                                    do {
                                                        if (B.ce !== D.ce && B.next.ce !== D.ce && B.ce !== F.ce && B.next.ce !== F.ce && n(B, B.next, D, F)) {
                                                            B = !0;
                                                            break b
                                                        }
                                                        B = B.next
                                                ...
                                                if (B = !B) if (B = void 0, B = p(D, F)) if (B = void 0, B = p(F, D)) {
                                                    ...
                                                    G = (D.x + F.x) / 2;
                                                    I = (D.y + F.y) / 2;
                                                    do B.y > I !== B.next.y > I && B.next.y !== B.y && G < (B.next.x - B.x) * (I - B.y) / (B.next.y - B.y) + B.x && (H = !H),
                                                    B = B.next;
                                                    while (B !== D);
                                                    B = H
                                                }
            ...
            function f(a, b) {
                ...
                n = h.y,
                r = Infinity,
                s, c = h.next; c !== l;) d >= c.x && c.x >= m && d !== c.x && k(e < n ? d: f, e, m, n, e < n ? f: d, e, c.x, c.y) && (s = Math.abs(e - c.y) / (d - c.x), (s < r || s === r && c.x > h.x) && p(c, a) && (h = c, r = s)),
                c = c.next;
                return h
            }
            ...
            function q(a, b) {
                var c = new u(a.ce, a.x, a.y),
                d = new u(b.ce, b.x, b.y),
                e = a.next,
                f = b.Fa;
                a.next = b;
                b.Fa = a;
            ...
            function u(a, b, c) {
                ...
                this.x = b;
                this.y = c;
                this.Fk = this.co = this.z = this.next = this.Fa = null;
                this.t4 = !1
            }
            return {
                JI: function(k, h, l) {
        ...
        a.Zm = {
            ...
            normalize: function(b) {
                ...
                if (b) {
                    c = [];
                    for (var f = 0,
                    h = b.length; f < h; f += 1) c[f] = b[f] instanceof Array ? this.normalize(b[f]) : b[f] instanceof a.T ? [b[f].R, b[f].P] : b[f] instanceof a.G ? [b[f].x, b[f].y] : b[f]
                }
                return c
            },
            Tj: function(d, e) {
        ...
        Zga: function() {
            if (g.a.S3) return g.a.AI.push(this),
            !0
        },
        Opa: function() {
            this.q("error", {
        ...
        send: function(a, b, c, d) {
            ...
            if (!this.D.ww || !this.Zga()) {
                ...
                window[f] = function(a) {
                    ...
                    else if (3E4 === a.errcode && a.data) g.a.S3 = !0,
                    g.pb.load("AMap.AntiCrabFrame",
                    function() {
                ...
                if ( - 1 !== a.indexOf(g.w.Od + "/v") || -1 !== a.indexOf("yuntuapi.amap.com/datasearch") || -1 !== a.indexOf("webapi.amap.com/")) b = b + "&platform=JS&logversion=2.0" + ("&appname=" + g.w.ct),
                b += "&csid=" + g.a.w5(),
                b += "&sdkversion=" + g.w.Bq;
                if (c = this.D.kG) {
                    var l = [],
    ...
    for (wc = 0; wc < xc.length; wc += 1) $.PlaneGeometryUtil[xc[wc]] = function() {
        ...
        b = g.Zm.normalize(b);
        return g.Zm.Tj(a, b)
    };$.plugin = $.service = C.Hb.prototype.plugin;$.TileLayer.Satellite = C.o.lb.SS;$.TileLayer.RoadNet = C.o.lb.QS;$.TileLayer.google = C.o.lb.jD;$.TileLayer.Flexible = C.o.lb.Ly;$.TileLayer.WMS = C.o.lb.u7;$.TileLayer.WMTS = C.o.lb.v7;$.TileLayer.Traffic = C.o.lb.YS;$.Panorama.Events = C.event;$.TileLayer.PanoramaLayer = C.o.lb.wta;$.UA = {
        ie: g.l.mr,
        ielt9: g.l.cf,
        ielt11: g.l.jla,
        mobile: g.l.Y,
    ...
    var Ac = g.w;$.User = {
        key: Ac.key
    };window.AMap = $;window.AMap.BuryPoint = g.BuryPoint;window.AMap.Class = g.Z;
    if (!Ac.FB && "undefined" !== typeof arguments && arguments.callee) try {
        if (g.l.tr && window.localStorage) {
            ...
            new g.fb.XMLHttpRequest(Ac.vb + "/maps/cookie?key=amap_ver&value=" + Ac.hj, {
                dd: "GET",
                B3: "text/plain"
            })
        }
    } catch(Dc) {};g.ij = g.Z.extend({
        r: function(a, b, c, d) {
            this.start = a;
            this.end = b;
            this.transition = c;
        ...
        update: function() {
            ...
            "number" === typeof b && Math.abs(b - this.end) < this.precision ? (this.stop(), b = this.end) : this.GY = g.a.Kc(this.update);
            this.Pg = a;
            this.$ca(b)
        },
        stop: function(a) {
        ...
        r: function(a, b) {
            ...
            if (g.l.zI) {
                ...
                this.tc.X.h("complete", this.nq, this, !0);
            ...
            this.Ie("rotateEnable pitchEnable dragEnable keyboardEnable doubleClickZoom scrollWheel zoomEnable touchZoom".split(" "), b, !0);
        ...
        styleUrlChanged: function() {
            if (this.C.ci) {
                ...
                if (a !== this.Hl) {
                    ...
                    "normal" === c ? (this.Hl = "", this.set("nolimg", !!this.C.get("nolimg_param")), this.set("style", ""), this.qt = "") : (this.qy = !0, this.set("nolimg", !0), b = new g.fb.sb(32 > c.length ? g.w.vc + "://webapi.amap.com/style?name=" + c + "&key=" + g.w.key: g.w.vc + "://webapi.amap.com/v4/map/styles?styleid=" + c + "&s=rsv3&key=" + g.w.key + (b ? "&ispublic=1": ""), {
                        callback: "callback"
                    }), b.h("complete",
                    function(a) {
        ...
        $L: function() {
            ...
            this.C.refreshSize();
            var b = this.get("size");
            b && a && !b.cb(a) && (this.rR = b, this.zu = !0, this.set("display"), this.C3(b), this.get("resizeEnable") && this.ka("resize", {
                qna: a,
                e2: b
            }))
        },
        ...
        dba: function() {
            ...
            this.C.B = !1;
            if (g.l.cf || g.l.F5 && g.l.cH || g.l.Oma) this.jX();
            else {
                var a = this;
                g.F.$fa(this.J,
                function(b) {
        ...
        zla: function() {
            ...
            b.Iq = g.g.create("div", b.Rc, "amap-drags");
            ...
            var c = window.location.host; - 1 === c.indexOf("amap.com") && -1 === c.indexOf("gaode.com") && (b.bu.href = g.l.Y ? "http://m.amap.com": "http://gaode.com", b.bu.target = "_blank");
            ...
            350 < g.g.NG(this.J).width && (b.um.innerHTML = this.C.D.copyright, b.um.I1 = g.g.create("span", b.um, "amap-mcode"), this.jC());
            this.Sa = b
        },
        jC: function() {
            ...
            if (a) {
                ...
                c && this.Sa.um.I1 && (this.Sa.um.I1.innerHTML = "- " + c + "\u53f7", this.Sa.um.style.visibility = "visible", this.Sa.bu.style.display = "block");
                return c
            }
        },
        EU: function() {
        ...
        nq: function() {
            ...
            this.EU();
                ...
                f = a();
                e ? (e.o && e.o.La && (this.C.La || c()), f && (this.C.La || c(), this.r3(), b())) : f && (this.C.La || c(), b(), this.C.h3 = !0)
            }
        },
        layersChanged: function() {
            this.pa = this.pa || [];
            ...
            for (var c = !1,
            d = !0,
            e = this.get("labelzIndex"), b = 0; b < a.length; b += 1) if (!a[b].K0) if (a[b].Uh) - 1 === g.a.indexOf(this.pa, a[b].o) && this.pa.push(a[b].o);
            else {
                var f = this.sg(a[b]);
            ...
            for (b = 0; b < this.pa.length; b += 1) f = this.pa[b].X,
            f.vp && f.get("visible") && (c = !0, !1 === f.get("detectRetina") && (d = !1), e = f.get("textIndex") || e);
            this.tc && (c || "3D" !== this.C.view.type ? this.tc.NL = !1 : (c = g.a.find(a,
            function(a) {
        ...
        controlsChanged: function() {
            ...
            (c = b.Zs || b.addTo) && c.call(b, this.C, this.Sa.controls);
            else if (a.remove && a.remove.length) for (; 0 < a.remove.length;) b = a.remove.shift(),
            (c = b.pu || b.removeFrom) && c.call(b, this.C, this.Sa.controls)
        },
        nY: function() {
            if (!this.wN) {
                var a = this;
        ...
        Lga: function(a) {
            var b = null;
            if (a instanceof C.A.ob) b = new g.A.ob(a, this);
            else if (a instanceof C.A.Vm) b = new g.A.Vm(a, this);
            else if (a instanceof C.A.Fe) b = new g.A.Fe(a, this);
            else {
                var c = ["overlay"];
                ...
                a instanceof C.A.xc ? b = new g.A.xc(a, this) : a instanceof C.A.Fy ? b = new g.A.Fy(a, this) : a instanceof C.A.Tb ? b = new g.A.Tb(a, this) : a instanceof C.A.Mg ? b = new g.A.Mg(a, this) : a instanceof C.A.hs ? b = new g.A.xc(a, this) : a instanceof C.A.ns && (b = new g.A.xc(a, this))
            }
            return b
        },
        r_: function() {
            var a = this.je; ! this.qt || this.mh && this.mh.Bo || (a = "function" === typeof this.qt ? this.qt(this.kf.Q.zoom) : this.qt);
            return a
        },
        hva: function() {
            function a() {}
        ...
        gI: function(a) {
            ...
            else this.Xu || (this.oC = g.a.Kc(this.pc), this.Xu = !0)
        },
        pc: function() {
            this.oC = null;
            if (!this.wN) {
                ...
                if (this.pa && (a.size = this.C.get("size"), a.size.width && a.size.height)) {
                    for (var b = this.C.view.type,
                    c = [], d = 0, e = this.pa.length; d < e; d += 1) this.pa[d].Rk && this.pa[d].Rk !== b ? this.pa[d].La = !0 : (c.push(this.pa[d]), this.pa[d].Lk && c.push(this.pa[d].Lk));
                    c.sort(function(a, b) {
                        var c = a.get("zIndex"),
                        d = b.get("zIndex");
                        return c > d ? 1 : c === d ? a.GD > b.GD ? 1 : -1 : -1
                    });
                    a.pa = c;
                    ...
                    a.es = a.Q.zoom > b;
                    a.xf = a.Q.zoom > b ? "zoomOut": a.Q.zoom < b ? "zoomIn": "stable";
                    a.kya = !0;
                    a.OY = this.OY;
                    for (var b = !1,
                    f, c = !1,
                    d = 0; d < this.pa.length; d += 1) this.pa[d].di && this.pa[d].X.get("visible") && a.Q.zoom <= this.pa[d].X.get("zooms")[1] && (a.PQ = !0),
                    this.pa[d].xl().bd && (b = !0);
        ...
        destroyChanged: function() {
            this.wN = 1;
            this.U = {};
            this.tc && (this.tc.X.I("complete", this.nq, this), this.tc.Gg(), this.pa = g.a.Cn(this.pa, g.a.indexOf(this.pa, this.tc)));
        ...
        drawChanged: function() {
            ...
            } else if (this.lp) for (b = 0, c = this.lp.length; b < c; b += 1) this.lp[b].jpa(),
            this.lp[b].Bva(),
            this.I("click", this.lp[b].gxa, this)
        },
        te: function(a, b, c) {
            return this.C.view.te(a, b, c)
        },
        dg: function(a, b, c) {
        ...
        Y_: function(a, b) {
            ...
            for (l = 0; l < k.length; l += 1) {
                ...
                } else if ("DIV" === m.tagName) for (var r = m.childNodes,
                s = parseFloat(m.style.top) || 0 + c, m = parseFloat(m.style.left) || 0 + e, u = 0; u < r.length; u += 1) {
                    var v = r[u];
                    if ("CANVAS" === v.tagName || "IMG" === v.tagName) h = parseFloat(v.style.top) || 0,
        ...
        n2: function(a) {
            this.og = !1;
            this.Rs();
            this.C3(); ! a.c1 && this.C.get("limitBounds", null, !0) ? (a = this.aha()) && !a.cb(this.get("center")) ? this.rI(this.get("zoom"), a, !1, !0) : this.ka("moveend") : this.ka("moveend");
            this.set("display")
        },
        o2: function() {
            this.og = !0;
        ...
        dragEnableChanged: function() { (this.XA = this.get("dragEnable")) ? this.RJ() : this.DL()
        },
        ka: function(a, b) {
            if (this.C.be(a)) {
                var c;
        ...
        zW: function() {
            ...
            if (c || b) {
                ...
                a = this.get("centerCoords").Ya((new g.G(a, d)).Nd(this.S)); (d = this.oZ(a)) && (c = Math.round(this.te(d).Ya(this.te(a)).y));
                this.zr(this.Sa.Iq, b, c);
                a.x = (a.x + g.a.za) % g.a.za;
        ...
        oZ: function(a) {
            var b = this.C.view.iT(),
            c = this.rR.height * this.S / 2;
        ...
        gS: function() {
            if (g.l.ll && (g.l.OI || g.l.EF)) {
                for (var a = this.Sa.o.childNodes,
                b = 0; b < a.length; b += 1) {
                    var c = a[b];
                    c instanceof HTMLCanvasElement && (c.width = 0);
                    "amap-e" === c.className && (c.style.height = "0")
                }
                for (b = 0; b < this.pa.length; b += 1) c = this.pa[b],
                "undefined" !== typeof AMap.IndoorMap && c instanceof AMap.IndoorMap && (c.Xs && (c.Xs.width = 0), c.lw && (c.lw.width = 0))
            }
        },
        br: function(a) {
        ...
        ul: function() {
            ...
            e = new g.yf(b.Ya(a.Nd(e)), b.add(a.Nd(e))),
        ...
        dg: function(a, b) {
            ...
            c = this.get("centerCoords").add((new g.G(c, d)).Nd(Math.pow(2, 20 - (b || this.get("zoom")))));
        ...
        ul: function() {
            ...
            var e = new g.G(0, d);
            c = this.dg(e, !0);
            if (55 < this.He.pitch || !c) for (; ! c;) d += a / 40,
            e.y = d,
            c = this.dg(e, !0);
            this.top = d / a;
            e.x = b;
    ...
    });g.a.Xb = new g.G(215440491, 106744817);g.Hb.wb({
        kZ: function(a, b, c) {
            var d = this;
            d.ZC ? (clearTimeout(d.ZC), d.ZC = null) : (d.ka("zoomstart", {
                zoom: a
            }), d.q("zoomstart"));
        ...
        Cy: function(a, b, c, d) {
            ...
            if (e !== a) {
                ...
                var m;
                this.pd && this.pd.uu && (this.pd.stop(), this.pd.VO && (d = !0), this.pd.mB && (m = !0), this.pd = null, this.set("targetLevel", null));
        ...
        rI: function(a, b, c, d) {
            ...
            if (f || h) {
                ...
                if (c) f && (b || (this.q("zoomstart"), this.ka("zoomstart")), this.set("zoom", a), this.ka("zoomchange"), this.ka("zoomend"), this.q("zoomend")),
                h && (k || d || (this.ka("movestart"), this.q("movestart")), this.set("centerCoords", e), this.ka("mapmove"), this.q("moveend", {
                    c1: d
                })),
                this.set("targetLevel", null);
                    ...
                    m = e.Ya(this.get("centerCoords")).toFixed(3);
                    ...
                    this.pd.transition = function(a, b, c) {
                        return Math.pow(1 - Math.min(g.w.AF, c) / g.w.AF, 2)
                    };
                    this.pd.yp = function(b) {
                        0.02 > b ? (this.pd && (this.pd.stop(), this.pd = null), f && (this.set("zoom", a), this.ka("zoomchange"), this.ka("zoomend"), f = !1, this.q("zoomend")), h && (this.set("centerCoords", e), this.q("mapmove"), this.q("moveend", {
                            c1: d
                        })), this.set("targetLevel", null)) : (f && this.set("zoom", a - l * b), h && (b = e.Ya(m.Nd(b)).toFixed(3), this.set("centerCoords", b), this.ka("mapmove")));
                        this.set("display", 1)
                    };
                    this.pd.Rm(this);
                    f && !b && (this.q("zoomstart"), this.ka("zoomstart")); ! h || k || d || (this.q("movestart"), this.ka("movestart"))
                }
            }
        }
    });g.o = {};g.o.Ec = g.Z.extend({
        ha: [g.ra, g.Ge],
        r: function(a, b) {
            this.X = a;
            this.qd = [3, 18];
        ...
        Gg: function() {
            ...
            if (g.Aa && g.Aa.Zp && g.Aa.Zp.length) {
                var a = g.a.indexOf(g.Aa.Zp, this); - 1 !== a && (g.Aa.Zp = g.a.Cn(g.Aa.Zp, a))
            }
            if (a = this.Ib) {
        ...
        opacityChanged: function() {
            ...
            if (a = this.Ib) if (a.length) for (var b = 0; b < a.length; b += 1) this.iR(a[b]);
            else this.iR(a);
        ...
        nO: function() {
            ...
            if (a) {
                if (a instanceof g.we) {
                    var b = a.zj(),
                    a = a.Jn(),
                    c = this.e.Vb(new g.T(180, 0)).x,
                    d = this.e.Vb(b),
                    e = this.e.Vb(a),
                    f = this.e.get("center");
                    b.R > a.R && (0 < f.R ? e.x += c: d.x -= c);
                    this.H = [d.x, d.y, e.x, e.y]
                } else a instanceof g.yf ? this.H = [a.Zb.x, a.Zb.y, a.Md.x, a.Md.y] : a instanceof g.CD && "3D" === this.X.Rk && (b = a.path[1], d = this.e.Vb(a.path[0]), e = this.e.Vb(b), this.H = [d.x, d.y, e.x, e.y, a.R3, a.height]);
                return this.H
            }
            return null
        }
    ...
    var Ec = function() {
        ...
        push: function(a) {
            a = new g.Wf.gq("", a);
            0 === this.count ? (this.Oc.Fa = null, a.Fa = this.Oc, this.Oc.next = a) : (this.qA.next = a, a.Fa = this.qA);
            this.count += 1;
            this.qA = a
        },
        dsa: function(a) {
        ...
        BU: function(a) {
            if (this.e.hasOwnProperty(a)) return a = this.e[a],
            this.JD && (a.remove(), this.rE(a)),
            a
        },
        rE: function(a) {
        ...
        hY: function(a) {
            if (! (this.count <= a || this.count < 2 * this.Lz.length)) {
                for (var b = this.JD ? this.Oc.Fa: this.Oc.next, c = {},
                d = 0, e = this.Lz.length; d < e; d++) c[this.Lz[d]] = !0;
                for (a = Math.ceil(2 * a / 3); b && this.count > a && (d = this.JD ? b.Fa: b.next, b.key && !c[b.key] && this.cA(b) && this.IH(b.value), b = d, b !== this.Oc && b !== this.qA););
            }
        },
        cA: function(a) {
        ...
        this.key = a;
        this.value = b
    };g.Wf.gq.prototype.Fa = null;g.Wf.gq.prototype.next = null;g.Wf.gq.prototype.remove = function() {
    ...
    g.lD = g.Z.extend({
        ...
        clear: function(a) {
            ...
            this.Dp.clear();
            if (a) for (; 0 < this.Qm.length;) a = this.Qm.pop(),
            this.pT(a);
            else this.Qm.forEach(function(a) {
                a.tm = !0
            })
        }
    });
    ...
    Ic.prototype.ib = function() {
        ...
        tileFunChanged: function() {
            ...
            this.yn = function(b, c, d) {
                ...
                if (!b.pr || b.pr.tm) b.loaded = !1,
                b.pr = ("3D" === this.e.C.view.type ? g.Al.tma: g.Al.oH).call(g.Al, e,
                function(a) {
                    b.pr = null;
                    a ? c(a) : d()
                },
    ...
    });g.Al = new g.lD(6, null);g.o.Tc = g.o.Ec.extend({
        r: function(a, b) {
        ...
        dataSourcesChanged: function() {
            ...
            a && a.length ? "string" === typeof a ? (new g.fb.sb(a)).h("complete",
            function(a) {
                this.E2(a.data);
                this.Vq = a.data;
                this.yl = !0;
        ...
        ka: function(a, b) {
            var c = {
                type: a,
                data: "mouseout" === a ? this.Yaa || null: b.Vs.bb,
                target: this.X
            };
        ...
        E2: function(a) {
            if (a) {
                ...
                for (var b = 0; b < a.length; b += 1) {
                    ...
                    c = this.map.Vb(c);
                    c = new g.Gh({
                        name: "point-" + g.a.Ab(this),
                        ea: new g.ya.kg([c.x, c.y], !0)
                    });
                    c.wq = this;
                    c.bb = a[b];
                    this.yF(c)
        ...
        tka: function(a) {
            if ("geojson" === a) return new g.p6({
                map: this.map
            });
            if ("topjson" === a) return new g.Nta({
                map: this.map
            });
            if ("subway" === a) return new g.Ita({
                map: this.map
            })
        },
        uoa: function(a) {
            if (a) {
                ...
                if (a.rules) {
                    ...
                    d = 0,
                    e = b.length; d < e; d += 1) {
                        for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1) h[k].fill && (f[k] = new g.style.lg.vS(h[k].fill)),
                        h[k].stroke && (f[k] = new g.style.lg.VS(h[k].stroke));
                        h = f;
                        b[d].BI = h;
                ...
                if (a.symbolizers) {
                    b = a.symbolizers;
                    a = 0;
                    for (d = b.length; a < d; a += 1) b[a].fill && (b[a] = new g.style.lg.vS(b[a].fill)),
                    b[a].stroke && (b[a] = new g.style.lg.VS(b[a].stroke));
                    c.BI = b
                }
                a = new g.zJ(c)
            } else a = new g.zJ({});
        ...
        qw: function(a) {
            this.yl = !0;
            for (var b = 0,
            c = a.length; b < c; b += 1) this.yF(a[b])
        },
        clear: function() {
            this.yl = !0;
            this.Vq = [];
        ...
        remove: function(a, b) {
            var c = g.a.Ab(a).toString(),
            d = a.lc();
            this.jp[c] && (this.jp[c] = null, d && (c = "undefined" !== typeof b ? b: d.jd(), this.yQ.remove(c, a)))
        }
    });g.dk = g.Z.extend({
        r: function(a) {
        ...
        gha: function(a, b) {
            ...
            d.push(b);
            var f = b.Db;
            do { - 1 !== c && (d.push(f[c]), f = f[c].Db, c = -1);
                for (var h = f.length - 1; 0 <= h; h -= 1) {
                    ...
                    k = g.dk.ay((k.H[2] > a.H[2] ? k.H[2] : a.H[2]) - (k.H[0] < a.H[0] ? k.H[0] : a.H[0]), (k.H[3] > a.H[3] ? k.H[3] : a.H[3]) - (k.H[1] < a.H[1] ? k.H[1] : a.H[1]), k.Db.length + 2);
        ...
        P0: function(a, b) {
            var c;
            if (0 === b.Db.length) b.H = g.H.ib(a.H),
            b.Db.push(a);
            else {
                var d = this.gha(a, b),
                e = a;
                do {
                    if (c && "undefined" !== typeof c.Db && 0 === c.Db.length) {
                        ...
                        c = d.pop();
                        for (var h = 0,
                        k = c.Db.length; h < k; h += 1) if (c.Db[h] === f || 0 === c.Db[h].Db.length) {
                            c.Db.splice(h, 1);
                            break
                        }
                    } else c = d.pop();
                    ...
                    if ("undefined" !== typeof e.Me || "undefined" !== typeof e.Db || f) {
                        if (f) {
                            ...
                            c.Db = c.Db.concat(e)
                        } else g.H.extend(c.H, e.H),
                        c.Db.push(e);
                        if (c.Db.length <= this.N1) if (0 < d.length) e = {
                            H: g.H.ib(c.H)
                        };
                        else break;
                        else e = f = this.nma(c.Db),
                        1 > d.length && (c.Db.push(f[0]), d.push(c), e = f[1])
        ...
        yoa: function(a, b, c) {
            for (var d = g.dk.ay(b.H[2] - b.H[0], b.H[3] - b.H[1], b.Db.length + 1), e = g.dk.ay(c.H[2] - c.H[0], c.H[3] - c.H[1], c.Db.length + 1), f, h, k, l = a.length - 1; 0 <= l; l -= 1) {
                var m = a[l],
                ...
                m = Math.abs(g.dk.ay(m[1] - m[0], m[3] - m[2], c.Db.length + 2) - e),
                p = Math.abs(m - n);
                if (!h || !f || p < f) h = l,
                f = p,
                k = m < n ? c: b
        ...
        remove: function(a, b) {
            ...
            if (!1 === c[1]) {
                ...
                e = [];
                do d = e.length,
                e = e.concat(this.s3.apply(this, c));
                while (d !== e.length);
                return e
            }
        ...
        Wx: function(a, b, c, d, e, f) {
            ...
            do {
                ...
                for (var l = d.length - 1; 0 <= l; l -= 1) {
                    var m = d[l];
                    if (g.H.yg(a.H, m.H)) if ("undefined" !== typeof m.Db) k.push(m.Db);
                    else if ("undefined" !== typeof m.Me) if (b) c.push(m);
                    else if ("undefined" === typeof e || m.type === e) m = m.Me,
                    "undefined" !== typeof f ? h[g.a.Ab(m)] = m: c.push(m)
                }
            } while ( 0 < k . length );
        ...
        a *= b;
        return a * c / (a / (d * d))
    };g.A = g.A || {};g.A.Jh = g.Z.extend({
        ha: [g.ra, g.Ge],
        eoa: ["position", "altitude", "visible", "clickable", "bubble"],
        r: function(a, b) {
            this.map = b;
            this.Ie(this.eoa, a);
            this.W("zIndex", a);
        ...
        sc: function(a) { ("click" !== a.type && "rightclick" !== a.type && "dblclick" !== a.type && "longclick" !== a.type || this.get("clickable")) && this.ka(a.type, a)
        },
        QJ: function() {
            this.h("click", this.sc);
        ...
        Js: function(a) {
            ...
            if ("2D" == b) {
                ...
                this.zr(new g.G(e, b));
                this.ka("dragging", a)
            } else "3D" == b && a.Ma && (c = a.xb.Ya(this.Lf), b = c.x, c = c.y, e = a.Ma.Ya(this.m1), a.ig.Ya(this.l1), this.Lf = a.xb, "function" === typeof this.IB && this.IB(b, c, e), this.m1 = a.Ma, this.l1 = a.ig, this.ka("dragging", a))
        },
        Ks: function(a) {
            this.map.Nu();
            this.ka("dragend", a)
        ...
        Of: function(a) {
            var b = this.M.gb || this.map.get("centerCoords"),
        ...
        rX: function() {
            ...
            if (this.bq) this.bq.set("position", this.get("position"));
            else {
                var a = new C.A.ob({
        ...
        raiseOnDragChanged: function() {
            this.get("raiseOnDrag") ? (this.h("dragstart", this.rX, this), this.h("dragging", this.Og, this), this.h("dragend", this.pU, this)) : (this.I("dragstart", this.rX, this), this.I("dragging", this.Og, this), this.I("dragend", this.pU, this))
        },
        zr: function(a) {
        ...
        it: function() {
            ...
            if (this.map && a && !this.M) {
                ...
                a = this.map.Vb(a),
                a = this.M = new g.Gh({
                    name: "marker-" + g.a.Ab(this),
                    map: b,
                    ea: new g.ya.kg([a.x, a.y])
                });
        ...
        contentChanged: function() {
            if (this.M) {
                this.map.Ad.Em = !0; - 1 === g.a.indexOf(this.map.Ad.Eg, this.M) && this.map.Ad.Eg.push(this.M);
        ...
        isTopChanged: function() {
            var a = this.map.Ad.GI,
            b = this.get("isTop"),
            c = this.get("zIndex");
            a ? a === this ? this.M && this.M.ca && (this.M.ca.style.zIndex = b ? this.map.Ad.Tp + 10 : c, this.map.Ad.GI = b ? this: null) : (a.M && a.M.ca && (a.M.ca.style.zIndex = b ? a.get("zIndex") : this.map.Ad.Tp + 10), this.M && this.M.ca && (this.M.ca.style.zIndex = b ? this.map.Ad.Tp + 10 : c), this.map.Ad.GI = b ? this: a) : (this.map.Ad.GI = this, this.M && this.M.ca && (this.M.ca.style.zIndex = b ? this.map.Ad.Tp + 10 : c))
        },
        visibleChanged: function() {
        ...
        angleChanged: function() {
            if (!g.l.cf && this.M && this.M.ca) {
                ...
                e = -e;
                g.g.rotate(this.M.ca, this.get("angle") || 0, {
                    x: b,
                    y: e
                })
            }
        ...
        UM: function(a, b, c) {
            ...
            e = 0,
            f, h, k, l, m = this;
            a ? ("string" === typeof a ? (b = a, l = !0) : (b = a.get("image"), c = a.get("size"), f = a.get("imageSize"), d = c.width, e = c.height, f && (h = f.width, k = f.height)), !d && c && c.width && (d = c.width), !e && c && c.height && (e = c.height), c = "string" !== typeof a ? a.get("imageOffset") : {
                x: 0,
                y: 0
            }) : (b = g.w.fi + "/mark_bs.png", c = {
                x: 0,
                y: 0
            },
            d = 19, e = 33, h = 19, k = 33);
            ...
            a.src = b;
            h && k && (a.style.width = h + "px", a.style.height = k + "px");
            a.style.top = c.y + "px";
            a.style.left = c.x + "px";
            f.appendChild(a);
        ...
        moveChanged: function() {
            ...
            void 0 !== a && ("pause" === a.action ? this.woa() : "[object Array]" === Object.prototype.toString.call(a.ig) ? a.ig && ("resume" === a.action && this.AE ? this.moveTo(a.ig[a.ig.Eo || 0], a.speed, a.rb) : (this.AE && this.q("movestop"), a.ig.Eo = 0, this.set("position", a.ig[0]), this.cna(a.ig, a.speed, a.rb, a.kha))) : this.moveTo(a.ig, a.speed, a.rb, !0))
        },
        moveTo: function(a, b, c, d) {
            if (! (0 >= b)) {
                ...
                this.hi.yp = function(b) {
                    this.set("position", b);
                    d && this.Ub.q("moving", {
                        passedPath: [this.hi.start, this.get("position")]
                    });
                    this.q("moving");
        ...
        cna: function(a, b, c, d) {
            ...
            this.AE || (this.AE = !0, this.h("moving", e, this), this.h("moveend", f, this), this.h("movestop",
            function l() {
                this.AE = !1;
        ...
        Yr: function() {
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    this.Oha = d;
                    a = g.g.create("a", this.ula, "amap-info-close");
                    a.innerHTML = "\u00d7";
                    this.hN = a;
                    a.href = "javascript: void(0)";
                    g.l.sf && (g.F.h(a, "touchstart",
                    function(a) {
                        g.F.stop(a)
                    },
                    this), g.F.h(a, "touchend",
                    function(a) {
                        g.F.stop(a);
                        this.Ye.B = !0;
                        this.Ye.close();
        ...
        XR: function() {
            ...
            if (!a && b) {
                ...
                c = b.height - 23,
                d = b.width;
                if (g.l.Wi || g.l.Rt) c = this.Wg.childNodes[0].offsetHeight,
                d = this.Wg.childNodes[0].offsetWidth + 26;
                ...
                f.top = -15;
                f.left = d / 2 - 15;
                for (c = 1; 8 >= c; c += 1) d = g.g.create("div", a),
                f = [],
        ...
        Ml: function() {
            ...
            if (a && b && c) {
                ...
                this.get("isCustom");
                e = e.width;
                this.Rb.style.left = Math.round(b.x - e / 2 + (c.x || 0)) + "px";
        ...
        g9: function() {
            ...
            c = this.get("anchor");
            if (c) {
                var a = this.Wg.offsetWidth,
                d = this.Wg.offsetHeight,
                e, f, h = 2 - a / 2,
                k = 2 - d;
        ...
        wT: function() {
            if (this.get("position") && this.get("autoMove") && this.Wg) {
                for (var a = this.map,
                b = new g.md(this.Wg.offsetWidth, this.Wg.offsetHeight), c = a.sr(this.get("position"), this.get("altitude")).add(this.g9()), d = c.add(b.EC()), e = a.get("size"), f = a.Sja(), h = 0, k = 0, l = 0; l < f.length; l += 1) {
                    var m = f[l],
                    n = 0,
                    p = 0;
                ...
                d = d.add(new g.G(h, k));
                l = f = 0;
                0 > c.x || b.Vi() > e.Vi() ? f = 20 - c.x: e.Vi() < d.x && (f = e.Vi() - d.x - 25);
        ...
        Gg: function() {
            this.Rb && this.map && (this.Ye.FI = !1, this.get("closeWhenClickMap") && (this.map.I("clickstart", this.wW, this), this.map.I("clickend", this.vW, this)), this.get("retainWhenClose") ? this.map.bl.appendChild(this.Rb) : (this.Rb.parentNode === this.map.Sa.A && this.map.Sa.A.removeChild(this.Rb), this.Ye.A = null), this.map = null, this.Ye.Uh = !1, this.Ub.q("close", {
                type: "close",
                target: this.Ub
            }))
        },
    ...
    });g.ya.ye = g.extend({},
    {
        ...
        fR: function(a) {
            a && (this.ea = a, this.W("coords", a, !0), this.Gz || this.ZK) && (a.W("radius", this), a.W("center", this), a.W("resolution", this), a.W("strokeWeight", this))
        },
        setStyle: function(a) {
            this.zqa(a);
            this.ar()
        ...
        $wa: function(a) {
            for (var b = 0; b < this.Mk.length; b += 1) {
                var c = this.Mk[b];
    ...
    });g.Gh.ita = "geometry";g.ya.kg = g.ya.xe.extend({
        r: function(a, b) {
            this.ta = a;
            this.Yi = b;
            this.cg = null
        ...
        Ht: function(a, b, c, d) {
            ...
            if (Math.floor(e) !== e) b(c, f);
                ...
                if (e = f.Cm([a[0] - e, a[1] - h, a[0] + e, a[1] + h])) {
                    for (var q in e) if (e.hasOwnProperty(q) && (h = e[q], h.get("visible") && !h.get("noSelect"))) if (k = h.lc(), k instanceof g.ya.kg) if (this.Yi) {
                        l = this.j.Il;
                        ...
                        m = g.H.RM([[u[0] - m + p, u[1] - n + r], [u[0] + p, u[1] + r]]);
                        g.H.Jd(m, k) && c.push(h)
                    } else if ("undefined" !== typeof k.get("radius")) l = k.ta,
                    l = new g.G(l[0], l[1]),
                    m = new g.G(a[0], a[1]),
                    k = k.get("radius"),
                    "px" === h.get("unit") ? m.le(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h) : m.le(l) * Math.cos(h.get("center").P * Math.PI / 180) <= k / this.tp * Math.pow(2, 20 - this.zoom) && c.push(h);
                    else if ("AMap.Text" == h.Mo) l = h.get("params"),
                    l.visible && h.ca && g.g.zB(d, h.ca, "amap-markers") && c.push(h);
                    else {
                        if (l = h.get("params"), l.visible && h.ca) if (l.shape) for (k = k.ta, s = l.uw % 360, u = [a[0], a[1]], s && (v = (a[0] - k[0]) / this.S, x = (a[1] - k[1]) / this.S, t = Math.PI * s / 180, s = Math.cos( - t), w = Math.sin( - t), t = v * s - x * w, v = v * w + x * s, u[0] = k[0] + t * this.S, u[1] = k[1] + v * this.S), m = h.width * this.S, n = h.height * this.S, p = l.offset.x * this.S, r = l.offset.y * this.S, m = g.H.RM([[u[0] - m - p, u[1] - n - r], [u[0] - p, u[1] - r]]), k[0] instanceof Array || (k = [k]), n = k.length - 1; 0 <= n; n -= 1) {
                            if (g.H.Jd(m, k[n])) {
                                l.shape ? this.yB(h, u, k) && c.push(h) : c.push(h);
                                break
                            }
                        } else g.g.zB(d, h.ca, "amap-markers") && c.push(h)
                    } else k.Jd ? k.Jd(a) && c.push(h) : k.Ow && 1.8 * k.Ow(a) <= h.get("strokeWeight") * this.S && c.push(h);
        ...
        yB: function(a, b, c) {
            ...
            if ("circle" === a.D.type) {
                ...
                if ("poly" === a.D.type) return e = a.D.coords,
                e = this.NF(e),
                g.sd.Jd(d, e);
                if ("rect" === a.D.type) return e = a.D.coords,
                a = e[0],
                b = e[1],
                c = e[2],
                e = e[3],
        ...
        Ht: function(a, b, c, d, e) {
            ...
            for (var h = b.length,
            k = [], l = 0, m, n = [], p = 0; p < h; p += 1) m = b[p],
            m instanceof g.o.Tc && m.get("visible") && (n.push(this.Jt(m)), l += 1);
        ...
        Jka: function(a) {
            ...
            e = {};
            c.Nb(a.nodes,
            function(a) { ! 1 !== a.value && null !== a.value && (e[a.zoom] = g.w.vc + "://" + a.value, d.push(a.zoom))
            });
            return function(a) {
                a = c.Yc(a, 1);
        ...
        H2: function(a, b, c) {
            if (b[c]) console.log("customType repeat!!", c);
                ...
                if (a.styles) {
                    a = a.styles;
                    this.NH(d, a, e, this.Jja, {
                        Ila: !0
                    });
                    for (var e = 0,
                    h = f.length; e < h; e++) {
                        var k = f[e];
                        a[k[0]] ? this.NH(d, a, k[1], this.Qja, {
                            Jla: !0
                        }) : this.NH(d, a, k[2], this.ska)
                    }
                    a.texture && (this.NH(d, a, {
                        Za: "texture"
                    },
                    this.Jka), d.Pd = [], g.a.Nb(a.texture.nodes,
                    function(a) {
        ...
        mQ: function(a, b, c, d) {
            if (a) for (var e in a) if (a.hasOwnProperty(e) && g.a.Fj(a[e], "object")) {
                ...
                h = e;
                c && (h = c + ":" + e);
                if (f.detailedType) this.H2(f, b, h),
                this.mQ(f.detailedType, b, h, f);
                else if (f.subType) this.mQ(f.subType, b, h);
                else {
                    if (void 0 !== f.code) {
            ...
            if (this.e.C.ci) {
                ...
                if (a) {
                    ...
                    if (a.visible) {
                        ...
                        p && (n = this.zy(p, a.visible, "rgba(0, 0, 0, 0)"), p = this.vl(b.su(this.e.je.substr(1)), a.opacity, a.color, !0), f = this.zy(p, a.visible))
                    }
                    this.e.qt = n
                } else this.e.qt = "";
                ...
                this.s5 ? this.s5(this.rt) : this.set("display")
            }
        },
        zy: function(a, b) {
        ...
        vl: function(a, b, c) {
            ...
            if (a) {
                if (b) return d = b,
                "function" === typeof b && (d = b(this.e.kf.Q.zoom)),
                [a[0], a[1], a[2], g.a.Yc(d, 3)];
        ...
        tl: function(a, b, c, d) {
            ...
            if (e = this.IG(b)) if ("function" === typeof e.visible && !e.visible(h) || !1 === e.visible) f = "";
            else {
                f = 1;
                h = "";
                if (c) if (e.fillColor || e.Xd) f = e.Xd,
                h = e.fillColor;
                else {
                    if (e.color || e.opacity) f = e.opacity,
                    h = e.color
                } else if (e.strokeColor || e.jb) f = e.jb,
                h = e.strokeColor;
        ...
        gr: function(a, b, c) {
            ...
            var d = null,
            e = a,
            f = this.e.kf.Q.zoom; (d = this.IG(b)) && (e = "function" === typeof d.visible && !d.visible(f) || !1 === d.visible ? "": c(a, d.opacity, d.color));
    ...
    };g.O.Hb.wb(g.GZ);g.O.canvas.Hb = g.O.Hb.extend({
        r: function(a) {
            arguments.callee.ma.apply(this, arguments);
            this.type = "2D"
        },
        ...
        pc: function(a) {
            ...
            for (var c = a.pa,
            b = a.Q,
            d = this.e.C.get("features"), e = a.size.width, f = a.size.height, h = 0; h < c.length; h += 1) {
                var k = c[h],
                l = this.Jt(k),
                m = c[h].xl();
                if (l && l.j) if (!m.visible || k.PB || m.qd[0] > b.zoom || m.qd[1] < b.zoom || k.ga && 0 === k.ga.length) {
                    if (l = l.yj()) if (l.length) for (m = 0; m < l.length; m += 1) l[m].parentNode === this.J && this.J.removeChild(l[m]);
                    ...
                    p,
                    q = l.transform;
                    if (!q || !k || l.Ag && !this.e.C.La) c[h].Bk && k.parentNode !== this.J && (this.J.appendChild(k), c[h].Ib = k);
                    else {
                        c[h].Ib = k;
                        k.length || (k = [k], q = [q]);
                        for (var r = 0; r < k.length; r += 1) if (n = k[r], p = q[r], !p.kx) {
                            ...
                            c[h].VA ? (x.push("top:" + Math.floor(f / 2 + u) + "px"), x.push("left:" + Math.floor(e / 2 + s) + "px")) : n.a1 ? (x.push("height:" + n.height * v + "px"), x.push("width:" + n.width * v + "px"), x.push("top:" + (f / 2 - u * v) + "px"), x.push("left:" + (e / 2 - s * v) + "px")) : (1 !== v && (x.push(g.g.Ur[g.g.Xf] + "-origin:" + s + "px " + u + "px"), x.push(g.g.Ur[g.g.Xf] + ":scale3d(" + v + "," + v + ",1)")), x.push("top:" + Math.floor(f / 2 - u) + "px"), x.push("left:" + Math.floor(e / 2 - s) + "px"), l.$i && (x.push("height:" + n.height + "px"), x.push("width:" + n.width + "px")));
            ...
            k = this.e.Sa.o;
            c = this.e.Sa.A;
            g.g.Xf && "number" === typeof b.rotation && 0 !== b.rotation ? (a.style[g.g.Xf + "Origin"] = e / 2 + "px " + f / 2 + "px", a.style[g.g.Xf] = "rotate(" + b.rotation + "deg)", a.style.overflow = "visible", k.style.overflow = "visible", c.style.overflow = "visible") : (a.style.cssText = "", k.style.cssText = "-webkit-transform: translateZ(0);", c.style.cssText = "");
            this.e.zu = !1
        },
        sP: function(a, b) {
            if ("all" === b || void 0 === a.kl) return ! 0;
            for (var c = 0,
            d = a.kl.length; c < d; c++) if (g.a.ha(b, "region" === a.kl[c] ? "bg": a.kl[c])) return ! 0;
            return ! 1
        }
        ...
        bh: function(a, b, c) {
            function d(b) {
                a.loaded = !0;
                e.j && (a.status = "loaded", a.Ea = !0, a.$e = b, e.set("display", 0), "function" === typeof c && c())
            }
            var e = this;
            a.status = "loading";
            this.j.yn && this.j.yn.call(this, a, d,
            function() {
                a.loaded = !0;
        ...
        gAa: function(a, b, c, d) {
            ...
            for (var f = 0; f < a.length; f += 1) {
                ...
                } else h = new g.dq(c, k, h),
                k = h + "",
                h = new g.lb(h); ! e[k] && h && (e.push(h), e[k] = 1)
            }
            return e
        },
        rG: function(a, b) {
            ...
            if (this.j.fF) {
                var e, f, h, k, l, m, n, p = function() {
                    var p = 0;
                    for (e = a.length - 1; 0 <= e; e -= 1) f = a[e],
                    p += f.length;
                    ...
                    d.ER = a;
                    for (e = a.length - 1; 0 <= e; e -= 1) for (f = a[e], h = [], k = [], f.HQ = h, f.fu = k, l = f.length - 1; 0 <= l; l -= 1) m = f[l],
                    n = m.oa,
                    c.j.e.mh.iy(n.x, n.y, n.z,
                    function() {
                        var c = l;
                        return function(e) {
        ...
        Lm: function(a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            if (a.length) if (this.cI) this.AH = !0;
            else {
                for (var c = a.length - 1; 0 <= c; c -= 1) {
                    ...
                    if (d.length) for (var e = Math.pow(2, 20 - d[0].oa.z), c = d.length - 1; 0 <= c; c--) {
                        ...
                        this.sa.set(f.key, f); ! b && f.pe ? f.pe = !1 : f.status = "loading"
                    }
                }
                var l = this;
                this.rG(a,
                function(a) {
                    for (var c = a.length - 1; 0 <= c; c -= 1) {
                        ...
                        if (d.length) if (l.di) {
                            ...
                            l.Au(d, l.$i ? 1 : 0);
                            for (var f = 0,
                            k = 0; f < d.length;) l.JP(d.slice(50 * k, 50 * k + 50), e, b),
                            f += 50,
                            k += 1
                        } else for (e = function() {
                            var a = d.length;
                            return function() {
                                if (0 === --a) {
                                    ...
                                    l.j.X.Mj || (g.ze.Te.end(b), g.ze.Te.end(g.extend(b, {
                                        index: 1
                                    })))
                                }
                            }
        ...
        Au: function(a, b) {
            if (a.length) {
                var c = this.hb.Wc(this.od << 20 - a[0].oa.z),
                d = Math.floor(c.x),
                e = Math.floor(c.y);
                a.sort(function(a, c) {
                    var k = a.oa,
        ...
        ao: function(a, b) {
            ...
            for (q = m.length - 1; 0 <= q; q -= 1) if (k = m[q], !(k.zv < b.opacity)) if (p.z = k.oa.z, p.x = k.oa.x, p.y = k.oa.y, p.z === this.ab) s[p + ""] |= 16;
            else if (p.z < this.ab) {
                if (s[p + ""] |= 64, this.zi) for (w = this.ab - p.z, v = Math.max(c.Ic, p.x << w), r = Math.min(c.Hc, (p.x + 1 << w) - 1), x = Math.max(c.nc, p.y << w), t = Math.min(c.Bc, (p.y + 1 << w) - 1), p.z = this.ab, w = v; w <= r; w += 1) for (p.x = w, y = x; y <= t; y += 1) p.y = y,
                z = p + "",
                s[z] |= 32,
                u[z] = u[z] ? Math.max(k.oa.z, u[z]) : k.oa.z
                ...
                t = x << 1;
                k = 0;
                for (w = 2; 0 < w; w -= 1) for (p.x = r + w, y = 2; 0 < y; y -= 1) p.y = t + y,
                s[p + ""] & 5 && (k += 1);
                p.z -= 1;
                p.x = v;
                p.y = x;
            ...
            q = !0;
            this.sa.rZ();
            for (w = e.Ic; w <= e.Hc; w += 1) for (p.x = w, y = e.nc; y <= e.Bc; y += 1) p.y = y,
            k = this.ex(p),
            this.Gs(k),
            v = !1,
            k.Ea ? (k.Td = this.Td, this.St(c, w, y) && (m.push(k), this.ek && (k.Uc !== this.Uc || 1 > k.zv) && (v = !0))) : (q = !1, this.St(c, w, y) && (v = !0), k.status && !k.pe || this.se !== d || this.$u && !this.St(this.$u, w, y) || l.push(k)),
            v && n.push(k);
            ...
            if (this.yi) {
                ...
                for (r = this.ab + 1; n.length && r <= k; r += 1) {
                    ...
                    n = [];
                    p.z = r;
                    for (q = l.length - 1; 0 <= q; q -= 1) if (w = l[q], v = s[w.key], v & 7) for (v = w.oa.x << 1, x = w.oa.y << 1, w = 1; 0 <= w; w -= 1) for (p.x = v + w, y = 1; 0 <= y; y -= 1) p.y = x + y,
                    z = p + "",
                    t = this.sa.PH(z),
                    s[z] & 5 && t && t.Ea ? (t.Qz = !0, t.Td = this.Td, m.push(t), this.Gs(t)) : n.push(new g.lb(p.ib()));
            ...
            if (!d && this.zi) for (w = !f.length || this.$i ? b.qd[0] : Math.max(b.qd[0], this.ab - 2), Math.max(w, this.ab - this.jba), r = this.ab - 1; n.length && r >= w; r -= 1) {
                ...
                p.y = k.oa.y >> 1,
                k = this.ex(p),
                y[k.key] || (y[k.key] = 1, v = !1, k.Ea && (!this.mda || s[k.key] & 64) ? (p.x = Math.min(c.Hc, Math.max(c.Ic, p.x << this.ab - r)), p.y = Math.min(c.Bc, Math.max(c.nc, p.y << this.ab - r)), p.z = this.ab, z = p + "", "number" === typeof u[z] && k.oa.z > u[z] ? v = !0 : k.Qz = !0, k.Td = this.Td, m.push(k), this.Gs(k)) : v = !0, v && n.push(k));
                m.length && f.push(m)
            }
            this.ER = h;
            this.au = this.qp = 0;
        ...
        XJ: function() {
            var a = this.e.C;
            return a.a3 && a.get("preloadMode") && 200 <= this.sa.Co && this.j.X.Wt() && "stable" != this.xf && this.nw && this.nw() && this.zoom !== this.ab
        },
        mu: function(a, b) {
            var c = b.H,
            d = b.qd;
            if (this.XJ() && this.ab >= d[0] + 1) {
                var d = [],
                e = null,
                e = "zoomOut" === this.xf ? Math.floor(this.zoom) : Math.ceil(this.zoom),
                e = this.BO(e, c);
                e.length && d.push(e);
        ...
        ru: function(a) {
            var b = Math.pow(2, a.Q.zoom - this.Qe),
            c = a.Q.hb.Ya(this.qr).Wc(this.Oj);
            this.transform = {
        ...
        qu: function() {
            for (var a = this.Ib.childNodes,
            b = a.length - 1; 0 <= b; b -= 1) a[b] && a[b].Uc !== this.Uc && this.Ib.removeChild(a[b])
        },
        gC: function(a, b) {
        ...
        Kr: function(a) {
            ...
            for (d = a.length - 1; 0 <= d; d -= 1) if (f = a[d], f.length) {
                ...
                for (var r = f.length - 1; 0 <= r; r -= 1) {
                    ...
                    m = n.oa;
                    var c = !0,
                    u = (new g.G((m.x << 20 - e) * this.od, (m.y << 20 - e) * this.od)).Ya(this.Ca),
                    u = u.Wc(this.Nf);
                    u.x = g.a.Yc(u.x, 1);
                    u.y = g.a.Yc(u.y, 1);
                    var v = 1;
                    ...
                    n.Uc = this.Uc;
                    n.zv = v;
                    n.Ea ? (s = n.$e, !s && n.Ob && n.Ob.$e && (s = n.Ob.$e), 0 !== v && s && (this.G_(s, u.x, u.y, p, p, v, m.z), s.parentNode !== this.Ib && (g.l.Wi && "overlayer" === this.j.get("type") && (s.style.display = "none"), this.Dt.appendChild(s)), s.Uc = this.Uc, n.se = this.se, h.push(n))) : n.Td = null
                }
                e = !0
            }
        ...
        uf: function() {
            this.transform = {
                translate: this.bN,
                scale: Math.pow(2, this.zoom - this.se),
                rotate: 0
            }
        }
        ...
        c = h / k;
        e.hg = 0;
        for (var l = [], f = this.YF, m = 0, n = 0, p = !1, q = h = 0; q < e.length; q += 1) e.hg += e[q],
        l[q] = {
            $A: e[q] * d,
            aB: e[q] * c,
            rx: h += e[q]
        ...
        f -= e[q],
        0 > f && !p && (m = q, n = -f, p = !0);
        for (p = 0; n + p <= k;) n < e[m] ? (f = n * d, h = n * c) : (f = l[m].$A, h = l[m].aB),
        a += f,
        b += h,
    ...
    window.CanvasRenderingContext2D.prototype.hia = function(a, b, c, d) {
        ...
        Zr: function(a, b) {
            ...
            this.Vg = a.Q.Vg;
            var c = !1;
            if (!this.Ca || 500 < Math.abs(this.gb.x - this.Ca.x) / this.S || 500 < Math.abs(this.gb.y - this.Ca.y) / this.S) c = !0;
            if (c || this.zoom << 0 !== this.zoom || this.Qe !== this.zoom) this.Ca = this.gb,
            this.Qe = this.zoom
        },
        Mt: function(a) {
        ...
        uf: function() {
            ...
            this.transform = {
                translate: this.Ca.Ya(this.gb).Wc(this.S),
                scale: a,
                rotate: 0
            }
        }
        ...
        nC: function(a, b) {
            ...
            for (f in a) if (a.hasOwnProperty(f)) {
                ...
                if (h.ca) k = h.ca;
                    ...
                    this.j.Em = !0; - 1 === g.a.indexOf(this.j.Eg, h) && this.j.Eg.push(h);
                    h.eg = !0
                }
                var n = l.offset,
                p = n.x,
                ...
                if (h.eg) {
                    ...
                    if (!g.l.cf) {
                        ...
                        z.push(g.g.W_(k, l.uw, {
                            x: p,
                            y: q
                        }))
                    }
                    z.push("display:" + (l.visible ? "block": "none") + ";");
                    k.style.cssText = z.join(";"); (n = l.label) && n.content && (l = l.k1, p = q = 0, n.offset && (q = n.offset.y + "px", p = n.offset.x + "px"), l.style.top = q, l.style.left = p, k.appendChild(l))
                } else if (h.U6 || this.zoom << 0 !== this.zoom || h.zoom !== this.zoom || k.parentNode !== this.Hk || h.Ca !== this.Ca) w = this.Rq(h.ea.ta),
                h.Ca = this.Ca,
                y = l.dD,
                q = Math.round(w[1] + q + y.y),
                p = Math.round(w[0] + p + y.x),
        ...
        Rq: function(a) {
            ...
            return [b / this.S, (a[1] - this.Ca.y) / this.S]
        }
    });
    var Ac = g.w,
    Jc = g.l,
    ...
    ga = document,
    Uc = !0,
    Vc = [];Jc.sf && Vc.push("touch");Jc.Y || Vc.push("mouse");Jc.zI && (Vc.push("vectorlayer", "overlay"), Jc.Pp ? Vc.push("wgl") : Vc.push("cgl"));
    if (Kc) {
    ...
    if (Jc.tr) {
        ...
        try {
            for (var wc = 0,
            bd = Vc.length; wc < bd; wc++) {
                var cd = JSON.parse(localStorage.getItem("_AMap_" + Vc[wc]));
                if (cd && cd.version === Ac.hj) $c.push(cd.script),
    ...
    if (Uc) for (wc = 0; wc < Vc.length; wc += 1) g.pb.NA(Vc[wc]).status = 1;
    else Ac.FB = !1, hd();
    function id() {
    ...
    function jd(a) {
        ...
        b.charset = "utf-8";
        b.src = a;
        b.id = "amap_plus_js"; (a = ga.head || ga.getElementsByTagName("head")[0] || ga.body) && a.appendChild(b)
    }
    function ed() {
        var a = ad.join("\n"),
        b = ga.createElement("style");
        b.type = "text/css"; - 1 === Ac.vb.indexOf("webapi.amap.com") && (a = a.replace(/webapi.amap.com/gi, Ac.vb.split("://")[1]));
...
})(["c536f4eae991666b64267ca01f855153", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "https://webapi.amap.com", 1, "1.4.13", null, "110000", "AMap.Driving", true, true, true, true, "1550583208-1"])